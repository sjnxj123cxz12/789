...
for (var h = 0, p = 0, d = 0, f = 0, v = 0, g = 0, m = 0, X = 0, I = 0, b = [ s, c, a, r, u, l ], y = [], C = 0; C < 6; C++) {
h = 0;
p = 0;
f = 0;
f = 0;
...
var t = {
url: "https://xocdialive-789." + lngui.ConfigManager.instance.ConfigInfo.Api + "/signalr/negotiate",
hub: "sedielivehub",
...
var c = t.A;
cc.XXLiveController.getInstance().updateInfo(c[0], c[2], c[1]);
cc.XXLiveController.getInstance().updateResult(null, null == (n = c[0]) ? void 0 : n.Result, null == (o = c[0]) ? void 0 : null == (s = o.Result) ? void 0 : s.ChipsData, c[2]);
cc.XXLiveController.getInstance().updateInput(c[2]);
break;
...
c = t.A[0], t.A[1];
cc.XXLiveController.getInstance().updateInfoCurrPlayer(c.Account);
...
c = t.A;
cc.XXLiveController.getInstance().playerBet(c);
break;
...
var a = t.A[0];
a.length > 0 && cc.XXLiveController.getInstance().vipPlayer(a);
break;
