...
e && (n *= 2);
if (n > fzgui.UserManager.instance.mainUserInfo.Money) cc.PopupController.getInstance().showMessage("Số dư không đủ."); else {
...
for (var l = 0, u = 0, p = 0, d = 0, f = 0, m = [ o, s, c, a, r, h ], X = [], I = 0; I < 6; I++) {
l = 0;
u = 0;
p = 0;
d = 0;
...
for (var g = 0; g < l; g++) X.push({
Gate: I + 1,
Amount: 5e5
});
for (g = 0; g < u; g++) X.push({
Gate: I + 1,
Amount: 1e5
});
for (g = 0; g < p; g++) X.push({
Gate: I + 1,
Amount: 1e4
});
for (g = 0; g < d; g++) X.push({
Gate: I + 1,
Amount: 5e3
});
for (g = 0; g < f; g++) X.push({
Gate: I + 1,
Amount: 1e3
});
}
...
fzgui.UserManager.instance.mainUserInfo.Money < t.Amount ? cc.PopupController.getInstance().showMessage("Số dư không đủ") : cc.XXController.getInstance().sendRequestOnHub(cc.MethodHubName.BET, t.Amount, t.Gate);
},
...
if (fzgui.UserManager.instance.mainUserInfo.Money < i) cc.PopupController.getInstance().showMessage("Số dư không đủ"); else {
...
this.xxHub.connect("OnXocDiaWebSocKet", "https://xocdia.dragonf1.xyz/signalr/negotiate", "sedieHub", fzgui.UserManager.instance.mainUserInfo.cookie, !1);
