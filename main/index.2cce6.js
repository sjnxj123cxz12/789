...
var c = t("./Dialog"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t, e, o) {
this.msg = t;
this.doneTitle = e;
this.onDismissed = o;
}, p = function(t) {
...
r([ s ], e.prototype, "designResolution", void 0);
return r([ a ], e);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
var c = cc._decorator, a = c.ccclass, s = c.property, u = c.menu, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.movingMode = !1;
...
return r([ a, u("lngui/Movement/Shake") ], e);
}(lngui.BhvShake);
o.default = l;
cc._RF.pop();
}, {} ],
...
var c = cc._decorator, a = c.ccclass, s = c.property, u = c.menu, l = (Math.PI, 
...
return r([ a, u("lngui/Movement/Sine (Chức năng chuyển động)") ], e);
}(lngui.BhvSine));
o.default = l;
cc._RF.pop();
}, {} ],
...
r([ s(cc.Boolean) ], e.prototype, "autoDownload", void 0);
...
var c = cc._decorator, a = c.ccclass, s = c.property, u = c.requireComponent, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.designResolution = new cc.Size(1280, 720);
...
var c = t("./PrefabEDefined"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
ConfigGame: [ function(t, e, o) {
"use strict";
cc._RF.push(e, "9a2a1vNOz1PkaOam8/cSZHk", "ConfigGame");
var n, i = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.UrlConfig = "https://assets.dsrcgoms.xyz/789/config.json";
e.Retry = 5;
e.DefaultData = {
Api: "dsrcgoms.xyz",
...
LinkAppIos: "https://apps.apple.com/vn/app/perfect-heart-maker/id6472875583?l=vi",
LinkAppAndroid: "https://apk-hitclub.fun",
HotUpdate: "1"
};
return e;
}
...
var c = t("./Dialog"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.lblMessage = null;
...
r([ s(cc.String) ], e.prototype, "optionString", void 0);
r([ s(cc.SpriteFrame) ], e.prototype, "optionSf", void 0);
return r([ a("DropDownOptionData") ], e);
...
var c = t("./DropDownOptionData"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.template = null;
...
r([ s(cc.AudioClip) ], e.prototype, "audioClick", void 0);
r([ s(cc.AudioClip) ], e.prototype, "musicPlay", void 0);
return r([ a ], e);
}(lngui.ESoundDefined);
o.default = u;
cc._RF.pop();
}, {} ],
EditorSpine: [ function(t, e) {
"use strict";
cc._RF.push(e, "28905GnOilMWY5hg4xc7inQ", "EditorSpine");
cc._RF.pop();
}, {} ],
...
o -= 3600 * r;
var c = e.formatNumberNN(r), a = Math.floor(o / 60), s = o -= 60 * a;
return i + c + ":" + e.formatNumberNN(a) + ":" + e.formatNumberNN(s);
};
...
var n = t.split("-"), i = n[0], r = n[1], c = n[2].substr(0, 2), a = n[2].split(":"), s = a[0].substr(a[0].length - 2, 2), u = a[1];
a[2].substr(0, 2);
return e && o ? c + "-" + r + "-" + i + " " + s + ":" + u : e ? c + "-" + r + "-" + i : o ? s + ":" + u : void 0;
};
...
r([ s(cc.Node) ], e.prototype, "nMiniGames", void 0);
r([ s(cc.Node) ], e.prototype, "nWidgetShowJackpot", void 0);
r([ s(cc.Node) ], e.prototype, "nLayerMiniGame", void 0);
r([ s(cc.String) ], e.prototype, "gameName", void 0);
return r([ a ], e);
...
e !== cc.HubName.DragonTigerHub && e !== cc.HubName.XocXocHub && e !== cc.HubName.ChatHub && e !== cc.HubName.ThreeCardsHub && e !== cc.HubName.TexasPokerHub && e !== cc.HubName.TLMNHub && e !== cc.HubName.MBHub && e !== cc.HubName.BaccaratHub && e !== cc.HubName.TreasureHub && e !== cc.HubName.BauCuaHub && e !== cc.HubName.LodeHub && e !== cc.HubName.VietlotHub || "ibom2.cc" !== a && "ibom3.cc" !== a || (a = "thanhno.club");
var s = "wss://" + cc.Config.getInstance().getSubDomainByHub(e) + a + "/signalr/connect?transport=webSockets&connectionToken=" + encodeURIComponent(n) + "&connectionData=" + encodeURIComponent(c) + "&tid=" + cc.Config.getInstance().getTID();
cc.ServerConnector.getInstance().getToken() && (s += "&access_token=" + encodeURIComponent(cc.ServerConnector.getInstance().getToken()));
i ? s = s.replace("/signalr/connect?", "/signalr/reconnect?") : cc.PopupController.getInstance().showBusy();
try {
cc.sys.isNative ? this.netControl = new WebSocket(s, [], cc.url.raw("resources/cacert.pem")) : this.netControl = new WebSocket(s);
} catch (t) {
...
r([ s(cc.Label) ], e.prototype, "label", void 0);
r([ s ], e.prototype, "surfix", void 0);
r([ s ], e.prototype, "duration", void 0);
r([ s ], e.prototype, "fromValue", void 0);
r([ s ], e.prototype, "toValue", void 0);
r([ s ], e.prototype, "range", void 0);
r([ s ], e.prototype, "sign", void 0);
r([ s ], e.prototype, "canRun", void 0);
r([ s ], e.prototype, "delta", void 0);
return r([ a ], e);
}(cc.Component);
o.LabelIncrement = u;
cc._RF.pop();
...
var c = t("./AlertDialog"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.lblStatus = null;
...
r([ s ], e.prototype, "tabIndex", void 0);
r([ s({
...
r([ s ], e.prototype, "isLoadFromUrl", void 0);
r([ s({
visible: function() {
return this.isLoadFromUrl;
}
...
r([ s ], e.prototype, "isNotLogin", void 0);
return r([ a ], e);
}(lngui.LoginFeature);
o.default = u;
cc._RF.pop();
...
r([ s(cc.Node) ], e.prototype, "nBg", void 0);
return r([ a ], e);
}(lngui.UIPopup);
o.default = u;
cc._RF.pop();
...
var c = t("./FormatUtil"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.label = null;
...
var i = cc._decorator, r = i.ccclass, c = i.property, a = (cc.Enum({
VN: 0,
EN: 1,
MM: 2
}), function() {
...
var a = "https://" + t + c + "/" + e;
console.log("urlRequest =====" + a);
lngui.UserManager.instance.mainUserInfo.GameToken && (a.includes("?") ? a += "&token=" + encodeURIComponent(lngui.UserManager.instance.mainUserInfo.GameToken) : a += "?token=" + encodeURIComponent(lngui.UserManager.instance.mainUserInfo.GameToken));
console.log(a);
r.timeout = 6e4;
r.open("GET", a);
...
r = cc.loader.getXMLHttpRequest();
var a = "https://" + t + c + "/" + e;
cc.ServerConnector.getInstance().getToken() && (a.includes("?"), a += "&token=" + encodeURIComponent(lngui.UserManager.instance.mainUserInfo.GameToken));
r.timeout = 6e4;
r.open(cc.RequestType.POST, a);
r.setRequestHeader("Content-Type", "application/json; charset=UTF-8");
...
r([ s([ cc.Integer ]) ], e.prototype, "POS_ITEM", void 0);
r([ s(cc.Integer) ], e.prototype, "MAX_ITEM", void 0);
r([ s(cc.Integer) ], e.prototype, "RATE_BIG_WIN", void 0);
r([ s(cc.Integer) ], e.prototype, "RATE_SUPER_WIN", void 0);
r([ s(cc.Integer) ], e.prototype, "TIME_DELAY_NEXT_SPIN", void 0);
r([ s(cc.Integer) ], e.prototype, "TIME_NEXT_SPIN", void 0);
r([ s(cc.Integer) ], e.prototype, "TIME_ANIM_WIN", void 0);
r([ s(cc.Integer) ], e.prototype, "TIME_ANIM_BIGWIN", void 0);
r([ s(cc.Integer) ], e.prototype, "TIME_ANIM_JACKPOT", void 0);
return r([ a ], e);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
r([ s(cc.Label) ], e.prototype, "txtTitle", void 0);
r([ s(cc.Label) ], e.prototype, "txtContent", void 0);
return r([ a ], e);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
r([ s(cc.Label) ], e.prototype, "txtMoneyJackpot", void 0);
r([ s(cc.Node) ], e.prototype, "nodeBigwin", void 0);
r([ s(cc.Label) ], e.prototype, "txtMoneyBigwin", void 0);
r([ s(cc.Node) ], e.prototype, "nodeWin", void 0);
r([ s(cc.Label) ], e.prototype, "txtMoneyWin", void 0);
return r([ a ], e);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
var c = t("./util/FormatUtil"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.txtSession = null;
...
if (c.y < -e && r.y + n < 0) {
r.y = r.y + n;
var a = this.mListCell[i], s = a.mIdx - this.mListCell.length;
a.setData(this.mListDataCell[s], s);
}
} else if (c.y > e && r.y - n > -this.scrollview.content.height) {
r.y = r.y - n;
var u = this.mListCell[i];
s = u.mIdx + this.mListCell.length;
u.setData(this.mListDataCell[s], s);
}
}
...
var a = -c.node.height * (.5 + i) - this.spacing * (i + 1);
c.node.setPosition(0, a);
...
r([ s(cc.Prefab) ], e.prototype, "cellHistory", void 0);
r([ s(cc.Integer) ], e.prototype, "heightItem", void 0);
r([ s(cc.Integer) ], e.prototype, "spacing", void 0);
r([ s(cc.Integer) ], e.prototype, "spawnCount", void 0);
r([ s(cc.Integer) ], e.prototype, "bufferZone", void 0);
return r([ a ], e);
}(lngui.UIPopup);
o.default = u;
cc._RF.pop();
...
var c = t("./SlotConstant"), a = t("./util/Util"), s = cc._decorator, u = s.ccclass, l = s.property, p = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.sprItem = null;
...
return a.default.random(0, this.mSlot.mSlotConfig.MAX_ITEM - 1);
};
...
r([ s(cc.Node) ], e.prototype, "circle", void 0);
r([ s(cc.Label) ], e.prototype, "txtLine", void 0);
r([ s(cc.Node) ], e.prototype, "line", void 0);
return r([ a ], e);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
var c = t("./SlotReel"), a = t("./SlotLine"), s = cc._decorator, u = s.ccclass, l = s.property, p = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.listSlotReel = [];
...
r([ l([ a.default ]) ], e.prototype, "listSlotLine", void 0);
return r([ u ], e);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
r([ s(cc.ScrollView) ], e.prototype, "scrollview", void 0);
r([ s(cc.Prefab) ], e.prototype, "cellRank", void 0);
r([ s(cc.Toggle) ], e.prototype, "btnBigwin", void 0);
r([ s(cc.Toggle) ], e.prototype, "btnJackpot", void 0);
r([ s(cc.Integer) ], e.prototype, "heightItem", void 0);
r([ s(cc.Integer) ], e.prototype, "spacing", void 0);
r([ s(cc.Integer) ], e.prototype, "spawnCount", void 0);
r([ s(cc.Integer) ], e.prototype, "bufferZone", void 0);
...
var c = t("./SlotItem"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.listItem = [];
...
var c = t("./SlotConstant"), a = cc._decorator, s = a.ccclass, u = (a.property, 
function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
var c = t("./util/FormatUtil"), a = t("./util/NumberUtil"), s = cc._decorator, u = s.ccclass, l = s.property, p = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.txtPot = null;
...
r([ l(a.default) ], e.prototype, "txtUserMoney", void 0);
r([ l(cc.Label) ], e.prototype, "txtLineSelect", void 0);
r([ l(a.default) ], e.prototype, "txtTotalWin", void 0);
...
var c = t("./SlotRoomUI"), a = t("./SlotEffect"), s = t("./SlotMachine"), u = t("./SlotRewardPool"), l = t("./SlotConstant"), p = t("./util/AudioUtil"), h = cc._decorator, f = h.ccclass, d = h.property, _ = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
r([ d(a.default) ], e.prototype, "mSlotEffect", void 0);
r([ d(s.default) ], e.prototype, "mSlotMachine", void 0);
...
r([ s(cc.Sprite) ], e.prototype, "sprBg", void 0);
r([ s(cc.Label) ], e.prototype, "txtLine", void 0);
r([ s(cc.Toggle) ], e.prototype, "togLine", void 0);
r([ s(cc.Sprite) ], e.prototype, "sprSelect", void 0);
r([ s(cc.Sprite) ], e.prototype, "sprUnselect", void 0);
return r([ a ], e);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
r([ s(cc.Toggle) ], e.prototype, "btnChan", void 0);
r([ s(cc.Toggle) ], e.prototype, "btnLe", void 0);
r([ s(cc.Toggle) ], e.prototype, "btnTatCa", void 0);
r([ s(cc.Toggle) ], e.prototype, "btnBoChon", void 0);
r([ s([ cc.Toggle ]) ], e.prototype, "listLineItem", void 0);
return r([ a ], e);
}(lngui.UIPopup);
o.default = u;
cc._RF.pop();
...
var c = t("./util/NumberUtil"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.listPot = [];
...
r([ s(cc.Label) ], e.prototype, "txtPotCount", void 0);
r([ s(sp.Skeleton) ], e.prototype, "skeEffect", void 0);
return r([ a ], e);
}(cc.Component);
o.default = u;
cc._RF.pop();
...
var c = t("./SlotXPotCell"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.listPotCell = [];
...
var c = t("./SlotHandler"), a = t("./SlotAudio"), s = t("./SlotConfig"), u = t("./SlotConstant"), l = t("./util/ToolTip"), p = t("./util/AudioUtil"), h = cc._decorator, f = h.ccclass, d = h.property, _ = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.nodeMain = null;
...
r([ d(s.default) ], e.prototype, "mSlotConfig", void 0);
r([ d(a.default) ], e.prototype, "mSlotAudio", void 0);
return r([ f ], e);
}(cc.Component);
o.default = _;
cc._RF.pop();
...
var c, a = t("./Utils"), s = cc._decorator, u = s.ccclass;
s.property;
(function(t) {
var e = function() {
this.target = null;
...
this.getInstance();
for (var c = null, s = 0; s < n.listeners.length; s++) {
var u = n.listeners[s];
if (u.target == t) {
c = u;
break;
...
var l = a.default.stringToInt(t.string), p = o - l;
c.curDuration = 0;
c.duration = i;
c.target = t;
...
r([ s(cc.SpriteFrame) ], e.prototype, "listSprite", void 0);
r([ s(cc.Label) ], e.prototype, "lbAction", void 0);
return r([ a ], e);
...
r([ s ], e.prototype, "dragAlwaysCenter", void 0);
r([ s ], e.prototype, "backToStartPosition", void 0);
r([ s ], e.prototype, "stickyDrag", void 0);
r([ s ], e.prototype, "propagateTouchEvent", void 0);
r([ s ], e.prototype, "dragScale", void 0);
r([ s ], e.prototype, "disableScrollViewWhileDrag", void 0);
return r([ a ], e);
}(lngui.UIDragDrop);
o.default = u;
cc._RF.pop();
...
r([ s(cc.Node) ], e.prototype, "analog", void 0);
r([ s(cc.Node) ], e.prototype, "background", void 0);
r([ s ], e.prototype, "radius", void 0);
r([ s ], e.prototype, "touchAnyWhereToStart", void 0);
r([ s ], e.prototype, "followFinger", void 0);
return r([ a ], e);
}(lngui.UIJoystick);
o.default = u;
cc._RF.pop();
...
r([ s(cc.Label) ], e.prototype, "lbTitle", void 0);
r([ s(cc.Label) ], e.prototype, "lbContent", void 0);
r([ s(cc.Node) ], e.prototype, "nCustomView", void 0);
r([ s(cc.Node) ], e.prototype, "nActionContainer", void 0);
...
r([ s(cc.Boolean) ], e.prototype, "hideCurScreenOnShow", void 0);
return r([ a ], e);
}(lngui.UIScreen);
o.default = u;
cc._RF.pop();
...
var c = t("./UIScrollBar"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
var c = t("./UITabbarItem"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.items = [];
...
r([ s(cc.String) ], e.prototype, "title", void 0);
r([ s(cc.Prefab) ], e.prototype, "prefab", void 0);
r([ s(cc.Node) ], e.prototype, "nodeContent", void 0);
r([ s(cc.Node) ], e.prototype, "nodeOn", void 0);
r([ s(cc.Node) ], e.prototype, "nodeOff", void 0);
return r([ a ], e);
}(lngui.UITabbarItem);
o.default = u;
cc._RF.pop();
...
var c, a = cc._decorator, s = a.ccclass, u = a.property;
(function(t) {
...
r([ s ], e.prototype, "message", void 0);
r([ s(cc.Prefab) ], e.prototype, "prefab", void 0);
r([ s(cc.Node) ], e.prototype, "target", void 0);
r([ s({
...
var c = t("./UITooltipHandler"), a = cc._decorator, s = a.ccclass, u = a.property, l = function(t) {
i(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.spBubble = null;
...
r([ s(cc.Component.EventHandler) ], e.prototype, "touchEvent", void 0);
r([ s ], e.prototype, "longClickEnabled", void 0);
return r([ a ], e);
...
r([ s(cc.Node) ], e.prototype, "nFaded", void 0);
r([ s(cc.Node) ], e.prototype, "nLoading", void 0);
r([ s(cc.Label) ], e.prototype, "lbPercent", void 0);
return r([ a ], e);
...
_process: function(e) {
var o = this._data, n = o.words, i = o.sigBytes, c = this.blockSize, a = i / (4 * c), s = (a = e ? t.ceil(a) : t.max((0 | a) - this._minBufferSize, 0)) * c, u = t.min(4 * s, i);
if (s) {
for (var l = 0; l < s; l += c) this._doProcessBlock(n, l);
var p = n.splice(0, s);
o.sigBytes -= u;
}
...
t.clamp();
for (var i = [], r = 0; r < o; r += 3) for (var c = (e[r >>> 2] >>> 24 - r % 4 * 8 & 255) << 16 | (e[r + 1 >>> 2] >>> 24 - (r + 1) % 4 * 8 & 255) << 8 | e[r + 2 >>> 2] >>> 24 - (r + 2) % 4 * 8 & 255, a = 0; a < 4 && r + .75 * a < o; a++) i.push(n.charAt(c >>> 6 * (3 - a) & 63));
var s = n.charAt(64);
...
var a = n[t.charCodeAt(c - 1)] << c % 4 * 2, s = n[t.charCodeAt(c)] >>> 6 - c % 4 * 2;
i[r >>> 2] |= (a | s) << 24 - r % 4 * 8;
r++;
}
return e.create(i, r);
...
(function(t) {
var e = n, o = e.lib, i = o.WordArray, r = o.Hasher, c = e.algo, a = [];
(function() {
...
var r = this._hash.words, c = t[e + 0], s = t[e + 1], f = t[e + 2], d = t[e + 3], _ = t[e + 4], y = t[e + 5], g = t[e + 6], m = t[e + 7], b = t[e + 8], S = t[e + 9], T = t[e + 10], I = t[e + 11], v = t[e + 12], E = t[e + 13], O = t[e + 14], R = t[e + 15], C = r[0], A = r[1], N = r[2], M = r[3];
C = u(C, A, N, M, c, 7, a[0]);
M = u(M, C, A, N, s, 12, a[1]);
N = u(N, M, C, A, f, 17, a[2]);
A = u(A, N, M, C, d, 22, a[3]);
C = u(C, A, N, M, _, 7, a[4]);
M = u(M, C, A, N, y, 12, a[5]);
N = u(N, M, C, A, g, 17, a[6]);
A = u(A, N, M, C, m, 22, a[7]);
C = u(C, A, N, M, b, 7, a[8]);
M = u(M, C, A, N, S, 12, a[9]);
N = u(N, M, C, A, T, 17, a[10]);
A = u(A, N, M, C, I, 22, a[11]);
C = u(C, A, N, M, v, 7, a[12]);
M = u(M, C, A, N, E, 12, a[13]);
N = u(N, M, C, A, O, 17, a[14]);
C = l(C, A = u(A, N, M, C, R, 22, a[15]), N, M, s, 5, a[16]);
M = l(M, C, A, N, g, 9, a[17]);
N = l(N, M, C, A, I, 14, a[18]);
A = l(A, N, M, C, c, 20, a[19]);
C = l(C, A, N, M, y, 5, a[20]);
M = l(M, C, A, N, T, 9, a[21]);
N = l(N, M, C, A, R, 14, a[22]);
A = l(A, N, M, C, _, 20, a[23]);
C = l(C, A, N, M, S, 5, a[24]);
M = l(M, C, A, N, O, 9, a[25]);
N = l(N, M, C, A, d, 14, a[26]);
A = l(A, N, M, C, b, 20, a[27]);
C = l(C, A, N, M, E, 5, a[28]);
M = l(M, C, A, N, f, 9, a[29]);
N = l(N, M, C, A, m, 14, a[30]);
C = p(C, A = l(A, N, M, C, v, 20, a[31]), N, M, y, 4, a[32]);
M = p(M, C, A, N, b, 11, a[33]);
N = p(N, M, C, A, I, 16, a[34]);
A = p(A, N, M, C, O, 23, a[35]);
C = p(C, A, N, M, s, 4, a[36]);
M = p(M, C, A, N, _, 11, a[37]);
N = p(N, M, C, A, m, 16, a[38]);
A = p(A, N, M, C, T, 23, a[39]);
C = p(C, A, N, M, E, 4, a[40]);
M = p(M, C, A, N, c, 11, a[41]);
N = p(N, M, C, A, d, 16, a[42]);
A = p(A, N, M, C, g, 23, a[43]);
C = p(C, A, N, M, S, 4, a[44]);
M = p(M, C, A, N, v, 11, a[45]);
N = p(N, M, C, A, R, 16, a[46]);
C = h(C, A = p(A, N, M, C, f, 23, a[47]), N, M, c, 6, a[48]);
M = h(M, C, A, N, m, 10, a[49]);
N = h(N, M, C, A, O, 15, a[50]);
A = h(A, N, M, C, y, 21, a[51]);
C = h(C, A, N, M, v, 6, a[52]);
M = h(M, C, A, N, d, 10, a[53]);
N = h(N, M, C, A, T, 15, a[54]);
A = h(A, N, M, C, s, 21, a[55]);
C = h(C, A, N, M, b, 6, a[56]);
M = h(M, C, A, N, R, 10, a[57]);
N = h(N, M, C, A, g, 15, a[58]);
A = h(A, N, M, C, E, 21, a[59]);
C = h(C, A, N, M, _, 6, a[60]);
M = h(M, C, A, N, I, 10, a[61]);
N = h(N, M, C, A, f, 15, a[62]);
A = h(A, N, M, C, S, 21, a[63]);
r[0] = r[0] + C | 0;
r[1] = r[1] + A | 0;
r[2] = r[2] + N | 0;
r[3] = r[3] + M | 0;
...
e.MD5 = r._createHelper(s);
e.HmacMD5 = r._createHmacHelper(s);
})(Math);
(function() {
var t = n, e = t.lib, o = e.WordArray, i = e.Hasher, r = t.algo, c = [], a = r.SHA1 = i.extend({
_doReset: function() {
this._hash = new o.init([ 1732584193, 4023233417, 2562383102, 271733878, 3285377520 ]);
},
_doProcessBlock: function(t, e) {
for (var o = this._hash.words, n = o[0], i = o[1], r = o[2], a = o[3], s = o[4], u = 0; u < 80; u++) {
if (u < 16) c[u] = 0 | t[e + u]; else {
var l = c[u - 3] ^ c[u - 8] ^ c[u - 14] ^ c[u - 16];
c[u] = l << 1 | l >>> 31;
}
var p = (n << 5 | n >>> 27) + s + c[u];
p += u < 20 ? 1518500249 + (i & r | ~i & a) : u < 40 ? 1859775393 + (i ^ r ^ a) : u < 60 ? (i & r | i & a | r & a) - 1894007588 : (i ^ r ^ a) - 899497514;
s = a;
a = r;
r = i << 30 | i >>> 2;
i = n;
...
(function(t) {
var e = n, o = e.lib, i = o.WordArray, r = o.Hasher, c = e.algo, a = [], s = [];
(function() {
function e(e) {
...
_doProcessBlock: function(t, e) {
for (var o = this._hash.words, n = o[0], i = o[1], r = o[2], c = o[3], a = o[4], l = o[5], p = o[6], h = o[7], f = 0; f < 64; f++) {
if (f < 16) u[f] = 0 | t[e + f]; else {
var d = u[f - 15], _ = (d << 25 | d >>> 7) ^ (d << 14 | d >>> 18) ^ d >>> 3, y = u[f - 2], g = (y << 15 | y >>> 17) ^ (y << 13 | y >>> 19) ^ y >>> 10;
u[f] = _ + u[f - 7] + g + u[f - 16];
}
var m = n & i ^ n & r ^ i & r, b = (n << 30 | n >>> 2) ^ (n << 19 | n >>> 13) ^ (n << 10 | n >>> 22), S = h + ((a << 26 | a >>> 6) ^ (a << 21 | a >>> 11) ^ (a << 7 | a >>> 25)) + (a & l ^ ~a & p) + s[f] + u[f];
h = p;
p = l;
l = a;
a = c + S | 0;
...
var r, h, b, S, T, I, v, E, O, R, C, A = this._hash.words, N = l.words, M = p.words, P = c.words, w = a.words, L = s.words, B = u.words;
I = r = A[0];
v = h = A[1];
E = b = A[2];
O = S = A[3];
...
for (o = 0; o < 80; o += 1) {
C = r + t[e + P[o]] | 0;
C += o < 16 ? f(h, b, S) + N[0] : o < 32 ? d(h, b, S) + N[1] : o < 48 ? _(h, b, S) + N[2] : o < 64 ? y(h, b, S) + N[3] : g(h, b, S) + N[4];
C = (C = m(C |= 0, L[o])) + T | 0;
r = T;
T = S;
S = m(b, 10);
...
h = C;
C = I + t[e + w[o]] | 0;
C += o < 16 ? g(v, E, O) + M[0] : o < 32 ? y(v, E, O) + M[1] : o < 48 ? _(v, E, O) + M[2] : o < 64 ? d(v, E, O) + M[3] : f(v, E, O) + M[4];
C = (C = m(C |= 0, B[o])) + R | 0;
I = R;
R = O;
O = m(E, 10);
...
var a = r[c];
r[c] = 16711935 & (a << 8 | a >>> 24) | 4278255360 & (a << 24 | a >>> 8);
}
return i;
},
clone: function() {
...
e.clamp();
for (var r = this._oKey = e.clone(), c = this._iKey = e.clone(), a = r.words, s = c.words, u = 0; u < n; u++) {
a[u] ^= 1549556828;
s[u] ^= 909522486;
}
...
(function() {
var t = n, e = t.lib, o = e.Base, i = e.WordArray, r = t.algo, c = r.SHA1, a = r.HMAC, s = r.PBKDF2 = o.extend({
cfg: o.extend({
keySize: 4,
hasher: c,
iterations: 1
...
for (var o = this.cfg, n = a.create(o.hasher, t), r = i.create(), c = i.create([ 1 ]), s = r.words, u = c.words, l = o.keySize, p = o.iterations; s.length < l; ) {
...
(function() {
var t = n, e = t.lib, o = e.Base, i = e.WordArray, r = t.algo, c = r.MD5, a = r.EvpKDF = o.extend({
cfg: o.extend({
keySize: 4,
hasher: c,
iterations: 1
...
compute: function(t, e) {
for (var o = this.cfg, n = o.hasher.create(), r = i.create(), c = r.words, a = o.keySize, s = o.iterations; c.length < a; ) {
u && n.update(u);
...
(function(t) {
var e = n, o = e.lib, i = o.WordArray, r = o.Hasher, c = e.x64.Word, a = e.algo, s = [], u = [], l = [];
(function() {
for (var t = 1, e = 0, o = 0; o < 24; o++) {
s[t + 5 * e] = (o + 1) * (o + 2) / 2 % 64;
var n = (2 * t + 3 * e) % 5;
t = e % 5;
e = n;
}
...
for (var T = 1; T < 25; T++) {
var I = (A = o[T]).high, v = A.low, E = s[T];
...
var A = o[T = h + 5 * _], N = p[T], M = p[(h + 1) % 5 + 5 * _], P = p[(h + 2) % 5 + 5 * _];
A.high = N.high ^ ~M.high & P.high;
A.low = N.low ^ ~M.low & P.low;
}
A = o[0];
var w = l[a];
A.high ^= w.high;
...
e.sigBytes = 4 * o.length;
this._process();
for (var c = this._state, a = this.cfg.outputLength / 8, s = a / 8, u = [], l = 0; l < s; l++) {
...
_doProcessBlock: function(t, e) {
for (var o = this._hash.words, n = o[0], i = o[1], r = o[2], c = o[3], a = o[4], l = o[5], p = o[6], h = o[7], f = n.high, d = n.low, _ = i.high, y = i.low, g = r.high, m = r.low, b = c.high, S = c.low, T = a.high, I = a.low, v = l.high, E = l.low, O = p.high, R = p.low, C = h.high, A = h.low, N = f, M = d, P = _, w = y, L = g, B = m, D = b, U = S, F = T, k = I, V = v, H = E, G = O, j = R, x = C, W = A, K = 0; K < 80; K++) {
var Y = u[K];
if (K < 16) var X = Y.high = 0 | t[e + 2 * K], J = Y.low = 0 | t[e + 2 * K + 1]; else {
var z = u[K - 15], q = z.high, Q = z.low, Z = (q >>> 1 | Q << 31) ^ (q >>> 8 | Q << 24) ^ q >>> 7, $ = (Q >>> 1 | q << 31) ^ (Q >>> 8 | q << 24) ^ (Q >>> 7 | q << 25), tt = u[K - 2], et = tt.high, ot = tt.low, nt = (et >>> 19 | ot << 13) ^ (et << 3 | ot >>> 29) ^ et >>> 6, it = (ot >>> 19 | et << 13) ^ (ot << 3 | et >>> 29) ^ (ot >>> 6 | et << 26), rt = u[K - 7], ct = rt.high, at = rt.low, st = u[K - 16], ut = st.high, lt = st.low;
X = (X = (X = Z + ct + ((J = $ + at) >>> 0 < $ >>> 0 ? 1 : 0)) + nt + ((J += it) >>> 0 < it >>> 0 ? 1 : 0)) + ut + ((J += lt) >>> 0 < lt >>> 0 ? 1 : 0);
Y.high = X;
Y.low = J;
}
var pt, ht = F & V ^ ~F & G, ft = k & H ^ ~k & j, dt = N & P ^ N & L ^ P & L, _t = M & w ^ M & B ^ w & B, yt = (N >>> 28 | M << 4) ^ (N << 30 | M >>> 2) ^ (N << 25 | M >>> 7), gt = (M >>> 28 | N << 4) ^ (M << 30 | N >>> 2) ^ (M << 25 | N >>> 7), mt = (F >>> 14 | k << 18) ^ (F >>> 18 | k << 14) ^ (F << 23 | k >>> 9), bt = (k >>> 14 | F << 18) ^ (k >>> 18 | F << 14) ^ (k << 23 | F >>> 9), St = s[K], Tt = St.high, It = St.low, vt = x + mt + ((pt = W + bt) >>> 0 < W >>> 0 ? 1 : 0), Et = gt + _t;
x = G;
W = j;
G = V;
j = H;
...
I = a.low = I + k;
a.high = T + F + (I >>> 0 < k >>> 0 ? 1 : 0);
E = l.low = E + H;
l.high = v + V + (E >>> 0 < H >>> 0 ? 1 : 0);
R = p.low = R + j;
p.high = O + G + (R >>> 0 < j >>> 0 ? 1 : 0);
A = h.low = A + W;
h.high = C + x + (A >>> 0 < W >>> 0 ? 1 : 0);
},
_doFinalize: function() {
var t = this._data, e = t.words, o = 8 * this._nDataBytes, n = 8 * t.sigBytes;
e[n >>> 5] |= 128 << 24 - n % 32;
...
(function() {
var t = n, e = t.x64, o = e.Word, i = e.WordArray, r = t.algo, c = r.SHA512, a = r.SHA384 = c.extend({
_doReset: function() {
...
t.SHA384 = c._createHelper(a);
t.HmacSHA384 = c._createHmacHelper(a);
})();
n.lib.Cipher || function(t) {
var e = n, o = e.lib, i = o.Base, r = o.WordArray, c = o.BufferedBlockAlgorithm, a = e.enc, s = (a.Utf8, 
a.Base64), u = e.algo.EvpKDF, l = o.Cipher = c.extend({
cfg: i.extend(),
...
pad: function(t, e) {
for (var o = 4 * e, n = o - t.sigBytes % o, i = n << 24 | n << 16 | n << 8 | n, c = [], a = 0; a < n; a += 4) c.push(i);
var s = r.create(c, n);
t.concat(s);
},
unpad: function(t) {
...
(function() {
var t = n, e = t.lib.BlockCipher, o = t.algo, i = [], r = [], c = [], a = [], s = [], u = [], l = [], p = [], h = [], f = [];
(function() {
...
var a = r[c - 1];
if (c % o) o > 6 && c % o == 4 && (a = i[a >>> 24] << 24 | i[a >>> 16 & 255] << 16 | i[a >>> 8 & 255] << 8 | i[255 & a]); else {
...
c = n - u;
a = u % 4 ? r[c] : r[c - 4];
s[u] = u < 4 || c <= 4 ? a : l[i[a >>> 24]] ^ p[i[a >>> 16 & 255]] ^ h[i[a >>> 8 & 255]] ^ f[i[255 & a]];
}
}
},
encryptBlock: function(t, e) {
this._doCryptBlock(t, e, this._keySchedule, c, a, s, u, i);
},
...
_doCryptBlock: function(t, e, o, n, i, r, c, a) {
for (var s = this._nRounds, u = t[e] ^ o[0], l = t[e + 1] ^ o[1], p = t[e + 2] ^ o[2], h = t[e + 3] ^ o[3], f = 4, d = 1; d < s; d++) {
...
_ = (a[u >>> 24] << 24 | a[l >>> 16 & 255] << 16 | a[p >>> 8 & 255] << 8 | a[255 & h]) ^ o[f++], 
y = (a[l >>> 24] << 24 | a[p >>> 16 & 255] << 16 | a[h >>> 8 & 255] << 8 | a[255 & u]) ^ o[f++], 
g = (a[p >>> 24] << 24 | a[h >>> 16 & 255] << 16 | a[u >>> 8 & 255] << 8 | a[255 & l]) ^ o[f++], 
m = (a[h >>> 24] << 24 | a[u >>> 16 & 255] << 16 | a[l >>> 8 & 255] << 8 | a[255 & p]) ^ o[f++];
t[e] = _;
t[e + 1] = y;
t[e + 2] = g;
t[e + 3] = m;
...
var u = i[r] = [], l = s[r];
for (o = 0; o < 24; o++) {
u[o / 6 | 0] |= e[(a[o] - 1 + l) % 28] << 31 - o % 6;
u[4 + (o / 6 | 0)] |= e[28 + (a[o + 24] - 1 + l) % 28] << 31 - o % 6;
}
u[0] = u[0] << 1 | u[0] >>> 31;
...
for (var n = 0; n < 16; n++) {
for (var i = o[n], r = this._lBlock, c = this._rBlock, a = 0, s = 0; s < 8; s++) a |= u[s][((c ^ i[s]) & l[s]) >>> 0];
this._lBlock = c;
this._rBlock = r ^ a;
}
var p = this._lBlock;
...
i = 0;
for (var r = 0; i < 256; i++) {
var c = i % o, a = e[c >>> 2] >>> 24 - c % 4 * 8 & 255;
r = (r + n[i] + a) % 256;
var s = n[i];
n[i] = n[r];
n[r] = s;
...
(function() {
var t = n, e = t.lib.StreamCipher, o = t.algo, i = [], r = [], c = [], a = o.Rabbit = e.extend({
_doReset: function() {
...
if (e) {
var r = e.words, c = r[0], a = r[1], u = 16711935 & (c << 8 | c >>> 24) | 4278255360 & (c << 24 | c >>> 8), l = 16711935 & (a << 8 | a >>> 24) | 4278255360 & (a << 24 | a >>> 8), p = u >>> 16 | 4294901760 & l, h = l << 16 | 65535 & u;
i[0] ^= u;
i[1] ^= p;
i[2] ^= l;
i[3] ^= h;
...
for (o = 0; o < 8; o++) {
var n = t[o] + e[o], i = 65535 & n, a = n >>> 16, s = ((i * i >>> 17) + i * a >>> 15) + a * a, u = ((4294901760 & n) * n | 0) + ((65535 & n) * n | 0);
c[o] = s ^ u;
}
...
(function() {
var t = n, e = t.lib.StreamCipher, o = t.algo, i = [], r = [], c = [], a = o.RabbitLegacy = e.extend({
_doReset: function() {
...
return t((a = t(t(o, e), t(i, c))) << (s = r) | a >>> 32 - s, n);
var a, s;
}
function n(t, e, n, i, r, c, a) {
return o(e & n | ~e & i, t, e, r, c, a);
}
function i(t, e, n, i, r, c, a) {
return o(e & i | n & ~i, t, e, r, c, a);
}
function r(t, e, n, i, r, c, a) {
return o(e ^ n ^ i, t, e, r, c, a);
}
function c(t, e, n, i, r, c, a) {
return o(n ^ (e | ~i), t, e, r, c, a);
}
function a(e, o) {
e[o >> 5] |= 128 << o % 32;
e[14 + (o + 64 >>> 9 << 4)] = o;
var a, s, u, l, p, h = 1732584193, f = -271733879, d = -1732584194, _ = 271733878;
for (a = 0; a < e.length; a += 16) {
s = h;
u = f;
l = d;
p = _;
h = n(h, f, d, _, e[a], 7, -680876936);
_ = n(_, h, f, d, e[a + 1], 12, -389564586);
d = n(d, _, h, f, e[a + 2], 17, 606105819);
f = n(f, d, _, h, e[a + 3], 22, -1044525330);
h = n(h, f, d, _, e[a + 4], 7, -176418897);
_ = n(_, h, f, d, e[a + 5], 12, 1200080426);
d = n(d, _, h, f, e[a + 6], 17, -1473231341);
f = n(f, d, _, h, e[a + 7], 22, -45705983);
h = n(h, f, d, _, e[a + 8], 7, 1770035416);
_ = n(_, h, f, d, e[a + 9], 12, -1958414417);
d = n(d, _, h, f, e[a + 10], 17, -42063);
f = n(f, d, _, h, e[a + 11], 22, -1990404162);
h = n(h, f, d, _, e[a + 12], 7, 1804603682);
_ = n(_, h, f, d, e[a + 13], 12, -40341101);
d = n(d, _, h, f, e[a + 14], 17, -1502002290);
h = i(h, f = n(f, d, _, h, e[a + 15], 22, 1236535329), d, _, e[a + 1], 5, -165796510);
_ = i(_, h, f, d, e[a + 6], 9, -1069501632);
d = i(d, _, h, f, e[a + 11], 14, 643717713);
f = i(f, d, _, h, e[a], 20, -373897302);
h = i(h, f, d, _, e[a + 5], 5, -701558691);
_ = i(_, h, f, d, e[a + 10], 9, 38016083);
d = i(d, _, h, f, e[a + 15], 14, -660478335);
f = i(f, d, _, h, e[a + 4], 20, -405537848);
h = i(h, f, d, _, e[a + 9], 5, 568446438);
_ = i(_, h, f, d, e[a + 14], 9, -1019803690);
d = i(d, _, h, f, e[a + 3], 14, -187363961);
f = i(f, d, _, h, e[a + 8], 20, 1163531501);
h = i(h, f, d, _, e[a + 13], 5, -1444681467);
_ = i(_, h, f, d, e[a + 2], 9, -51403784);
d = i(d, _, h, f, e[a + 7], 14, 1735328473);
h = r(h, f = i(f, d, _, h, e[a + 12], 20, -1926607734), d, _, e[a + 5], 4, -378558);
_ = r(_, h, f, d, e[a + 8], 11, -2022574463);
d = r(d, _, h, f, e[a + 11], 16, 1839030562);
f = r(f, d, _, h, e[a + 14], 23, -35309556);
h = r(h, f, d, _, e[a + 1], 4, -1530992060);
_ = r(_, h, f, d, e[a + 4], 11, 1272893353);
d = r(d, _, h, f, e[a + 7], 16, -155497632);
f = r(f, d, _, h, e[a + 10], 23, -1094730640);
h = r(h, f, d, _, e[a + 13], 4, 681279174);
_ = r(_, h, f, d, e[a], 11, -358537222);
d = r(d, _, h, f, e[a + 3], 16, -722521979);
f = r(f, d, _, h, e[a + 6], 23, 76029189);
h = r(h, f, d, _, e[a + 9], 4, -640364487);
_ = r(_, h, f, d, e[a + 12], 11, -421815835);
d = r(d, _, h, f, e[a + 15], 16, 530742520);
h = c(h, f = r(f, d, _, h, e[a + 2], 23, -995338651), d, _, e[a], 6, -198630844);
_ = c(_, h, f, d, e[a + 7], 10, 1126891415);
d = c(d, _, h, f, e[a + 14], 15, -1416354905);
f = c(f, d, _, h, e[a + 5], 21, -57434055);
h = c(h, f, d, _, e[a + 12], 6, 1700485571);
_ = c(_, h, f, d, e[a + 3], 10, -1894986606);
d = c(d, _, h, f, e[a + 10], 15, -1051523);
f = c(f, d, _, h, e[a + 1], 21, -2054922799);
h = c(h, f, d, _, e[a + 8], 6, 1873313359);
_ = c(_, h, f, d, e[a + 15], 10, -30611744);
d = c(d, _, h, f, e[a + 6], 15, -1560198380);
f = c(f, d, _, h, e[a + 13], 21, 1309151649);
h = c(h, f, d, _, e[a + 4], 6, -145523070);
_ = c(_, h, f, d, e[a + 11], 10, -1120210379);
d = c(d, _, h, f, e[a + 2], 15, 718787259);
f = c(f, d, _, h, e[a + 9], 21, -343485551);
h = t(h, s);
f = t(f, u);
d = t(d, l);
_ = t(_, p);
...
function l(t) {
return s(a(u(t), 8 * t.length));
}
function p(t, e) {
var o, n, i = u(t), r = [], c = [];
r[15] = c[15] = void 0;
i.length > 16 && (i = a(i, 8 * t.length));
for (o = 0; o < 16; o += 1) {
r[o] = 909522486 ^ i[o];
c[o] = 1549556828 ^ i[o];
}
n = a(r.concat(u(e)), 512 + 8 * e.length);
return s(a(c.concat(n), 640));
}
function h(t) {
var e, o, n = "";
