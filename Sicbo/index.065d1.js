...
s = s + e + "/" + o;
n.default.App.ACCESS_TOKEN && (s.includes("?") ? s += "&token=" + encodeURIComponent(n.default.App.ACCESS_TOKEN) + "&gate=" + n.default.App.ACCESS_TOKEN : s += "?token=" + encodeURIComponent(n.default.App.ACCESS_TOKEN) + "&gate=" + n.default.App.ACCESS_TOKEN);
a.timeout = 6e4;
a.open(t, s);
...
var s = t("../../framework/common/ConfirmDialog"), a = t("../../framework/common/Dialog"), r = t("./network/Sicbo.NetWorkClient"), l = t("./popup/chat/Sicbo.ChatController"), p = t("./popup/Sicbo.GraphView"), u = t("./popup/Sicbo.History"), h = t("./popup/Sicbo.MaxBet"), d = t("./popup/Sicbo.PlayersNotInGame"), f = t("./popup/Sicbo.TopRank"), S = t("./Sicbo.Common"), y = t("./Sicbo.Config"), b = t("./Sicbo.InfoView"), g = t("./Sicbo.InputView"), m = t("./Sicbo.ResultView"), v = cc._decorator, C = v.ccclass, I = v.property, T = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.spriteSound = null;
...
case "openPlateNow":
m.default.instance.updateResult(null, o[0], o[1], S.default.GAMESTATE.OPEN_PLATE, !0);
...
var o;
e.instance = null;
c([ I(cc.Sprite) ], e.prototype, "spriteSound", void 0);
c([ I([ cc.SpriteFrame ]) ], e.prototype, "sfSounds", void 0);
c([ I(cc.Sprite) ], e.prototype, "spriteBack", void 0);
c([ I(l.default) ], e.prototype, "nodeChat", void 0);
c([ I(a.default) ], e.prototype, "MsgSystem", void 0);
c([ I(cc.Node) ], e.prototype, "NodeTooltip", void 0);
c([ I(cc.Label) ], e.prototype, "lbMsg", void 0);
c([ I(p.default) ], e.prototype, "popupSoiCau", void 0);
c([ I(s.default) ], e.prototype, "popupConfirm", void 0);
c([ I(a.default) ], e.prototype, "popupRules", void 0);
c([ I(u.default) ], e.prototype, "popupHistory", void 0);
c([ I(f.default) ], e.prototype, "popupTopRank", void 0);
c([ I(d.default) ], e.prototype, "popoupPlayersNotInGame", void 0);
c([ I(h.default) ], e.prototype, "popupMaxBet", void 0);
return o = c([ C ], e);
}(cc.Component);
o.default = T;
cc._RF.pop();
...
var s = t("../Sicbo.InfoView"), a = t("./graphView/Sicbo.GrahpDiceSumView"), r = t("./graphView/Sicbo.GraphCatCauView"), l = t("./graphView/Sicbo.GraphDice3View"), p = t("./graphView/Sicbo.GraphView100"), u = t("../../../framework/common/Dialog"), h = cc._decorator, d = h.ccclass, f = h.property, S = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
var s = t("../../../framework/common/Dialog"), a = t("../../../framework/common/Utils"), r = t("../network/Http"), l = t("../Sicbo.Assets"), p = t("../Sicbo.Common"), u = t("../Sicbo.Config"), h = t("../Sicbo.Controller"), d = cc._decorator, f = d.ccclass, S = d.property, y = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = null;
...
c([ S(cc.Node) ], e.prototype, "content", void 0);
c([ S(cc.Node) ], e.prototype, "template", void 0);
c([ S(cc.Label) ], e.prototype, "lblPage", void 0);
c([ S(cc.Node) ], e.prototype, "btnNext", void 0);
c([ S(cc.Node) ], e.prototype, "btnBack", void 0);
return c([ f ], e);
}(s.default);
o.default = y;
cc._RF.pop();
...
var s = t("../../framework/common/Utils"), a = t("./network/Sicbo.NetWorkClient"), r = t("./settings/Sicbo.Settings"), l = t("./Sicbo.Assets"), p = t("./Sicbo.ChipItem"), u = t("./Sicbo.ChipPool"), h = t("./Sicbo.Common"), d = t("./Sicbo.Controller"), f = t("./Sicbo.InfoView"), S = t("./Sicbo.PlayerData"), y = t("./Sicbo.ResultView"), b = cc._decorator, g = b.ccclass, m = b.property, v = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
c % 2 == 0 && (s.children[0].active = !1);
if (1 == r) {
s.children[1].color = cc.Color.YELLOW;
s.children[2].color = cc.Color.YELLOW;
} else if (2 == r) {
s.children[1].color = cc.Color.GREEN;
s.children[2].color = cc.Color.GREEN;
} else if (3 == r) {
s.children[1].color = cc.Color.BLUE;
s.children[2].color = cc.Color.BLUE;
}
