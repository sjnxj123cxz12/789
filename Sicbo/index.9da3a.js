...
"Sb.Assets": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "f00fb8SZ6xBAJL3POdEBsJs", "Sb.Assets");
...
if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(t, e, o, i); else for (var c = t.length - 1; c >= 0; c--) (n = t[c]) && (a = (s < 3 ? n(a) : s > 3 ? n(e, o, a) : n(e, o)) || a);
return s > 3 && a && Object.defineProperty(e, o, a), a;
};
Object.defineProperty(o, "__esModule", {
value: !0
});
var a = cc._decorator, c = a.ccclass, r = a.property, l = function(t) {
n(e, t);
function e() {
...
"Sb.ChatController": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "44e11S6ZKBN8p60k/tWpTaY", "Sb.ChatController");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../Sb.Common"), c = t("../../Sb.Controller"), r = t("../../network/Sb.NetWorkClient"), l = t("./Sb.ChatListView"), p = cc._decorator, u = p.ccclass, h = p.property, d = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.chatListView = null;
...
(e = cc.moveTo(.5, cc.v2(320, 0))).easing(cc.easeQuadraticActionInOut());
...
this.node.stopAllActions();
var e;
(e = cc.moveTo(.5, cc.v2(800, 0))).easing(cc.easeQuadraticActionInOut());
...
if ("" == this.edBoxChat.string || this.edBoxChat.string.length <= 1) c.default.instance.showMsg("Nội dung chát quá ngắn!"); else if (this.edBoxChat.string.length >= 100) c.default.instance.showMsg("Nội dung chát quá dài!"); else {
...
"../../Sb.Common": "Sb.Common",
"../../Sb.Controller": "Sb.Controller",
"../../network/Sb.NetWorkClient": "Sb.NetWorkClient",
"./Sb.ChatListView": "Sb.ChatListView"
} ],
"Sb.ChatListView": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "65037qJx0dJP65I8ZNi9UbY", "Sb.ChatListView");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../Sb.Assets"), c = t("../../Sb.InfoView"), r = cc._decorator, l = r.ccclass, p = r.property, u = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = null;
...
parseInt(t[3]) == c.default.instance.getAccountIdIsMe() ? e.children[1].color = cc.Color.YELLOW : e.children[1].color = cc.Color.GREEN;
...
"../../Sb.Assets": "Sb.Assets",
"../../Sb.InfoView": "Sb.InfoView"
} ],
"Sb.ChipItem": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "c8adcGTlPZDGbjZVmRwvJ32", "Sb.ChipItem");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("./Sb.Assets"), c = t("./Sb.ChipPool"), r = t("./Sb.Controller"), l = t("./Sb.InputView"), p = cc._decorator, u = p.ccclass, h = p.property, d = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.spriteChip = null;
...
var n = this.position.lerp(t, 1), s = this.node.parent.convertToWorldSpaceAR(this.node.position), a = (this.node.convertToNodeSpaceAR(s), 
e % 2 == 0 ? n.x - n.x / 2 : -(n.x - n.x / 2)), c = e % 2 == 0 ? n.y - n.y / 2 : -(n.y - n.y / 2), r = (cc.bezierTo(o, [ cc.v2(this.node.position.x, this.node.position.y / 2), cc.v2(a, c), t ]), 
...
i.easing(cc.easeQuadraticActionInOut());
var n = this.position.lerp(t, 1), s = this.node.parent.convertToWorldSpaceAR(this.node.position), a = (this.node.convertToNodeSpaceAR(s), 
e % 2 == 0 ? n.x - n.x / 2 : -(n.x - n.x / 2)), c = e % 2 == 0 ? n.y - n.y / 2 : -(n.y - n.y / 2), r = (cc.bezierTo(o, [ cc.v2(this.node.position.x, this.node.position.y), cc.v2(a, c), t ]), 
...
try {
setTimeout(function() {
r.default && r.default.instance.node && c.default.instance.putToPool(t);
}, 500);
} catch (t) {}
};
var o;
...
"./Sb.Assets": "Sb.Assets",
"./Sb.ChipPool": "Sb.ChipPool",
"./Sb.Controller": "Sb.Controller",
"./Sb.InputView": "Sb.InputView"
} ],
"Sb.ChipPool": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "beb8fR8MyJDwbr1g7fmdrFx", "Sb.ChipPool");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
"Sb.Common": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "c3f75EVaoBHdpxZx0UZyhro", "Sb.Common");
Object.defineProperty(o, "__esModule", {
value: !0
});
var i;
...
"Sb.Config": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "d0e04rMHL1Bvbh3zaqMskEp", "Sb.Config");
Object.defineProperty(o, "__esModule", {
value: !0
});
var i = function() {
...
"Sb.Controller": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "687e045ithMOqZ1WZVUCa+H", "Sb.Controller");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../framework/common/ConfirmDialog"), c = t("../../framework/common/Dialog"), r = t("./Sb.Common"), l = t("./Sb.Config"), p = t("./Sb.InfoView"), u = t("./Sb.InputView"), h = t("./Sb.ResultView"), d = t("./network/Sb.NetWorkClient"), f = t("./popup/Sb.GraphView"), S = t("./popup/Sb.History"), y = t("./popup/Sb.MaxBet"), b = t("./popup/Sb.PlayersNotInGame"), g = t("./popup/Sb.TopRank"), m = t("./popup/chat/Sb.ChatController"), v = cc._decorator, C = v.ccclass, I = v.property, T = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.spriteSound = null;
...
d.default.getInstance().reConnect();
};
e.prototype.onEnable = function() {
var t = this;
null != l.default.App.ACCESS_TOKEN ? d.default.getInstance().checkConnect(function(e) {
console.log("Check connection webserver: " + e);
if (e) {
d.default.getInstance().addOnClose(function() {
console.log("SICBO addOnClose");
d.default.getInstance().isReconnect ? setTimeout(function() {
t.node && (d.default.getInstance().isReconnect = !1);
}, 2e3) : t.node.active && t.actBackGame();
}, t, null);
d.default.getInstance().addListener(function(e, o) {
switch (e) {
case "sessionInfo":
p.default.instance.updateInfo(o[0], o[0].Phrase, null);
u.default.instance.updateInput(o[0].Phrase);
break;

case "gameHistory":
p.default.instance.setListSoiCau(o[0]);
break;

case "startActionTimer":
p.default.instance.updateInfo(o[0], o[2], o[1]);
h.default.instance.updateResult(null, o[0].Result, o[0].ChipsData, o[2], null);
u.default.instance.updateInput(o[2]);
break;

case "playerLeave":
if (o && o.length > 0) {
p.default.instance.playerLeave(o);
t.playerLeave(o);
}
break;

case "joinGame":
p.default.instance.updateInfoCurrPlayer(o[0].Account);
break;

case "betSession":
u.default.instance.showLastInput(o[0]);
break;

case "playerBet":
u.default.instance.playerBet(o);
break;

case "betSuccess":
u.default.instance.ShowMyBets(o);
break;

case "winResultVip":
try {
setTimeout(function() {
t.node && p.default.instance.winResultVip(o[0]);
}, 2500);
} catch (t) {
console.error(t);
}
...
try {
setTimeout(function() {
t.node && p.default.instance.winResult(o[0]);
}, 2500);
} catch (t) {
console.error(t);
}
...
t.node && p.default.instance.totalUserWin(o[0]);
}, 2500);
break;
...
case "openPlateNow":
h.default.instance.updateResult(null, o[0], o[1], r.default.GAMESTATE.OPEN_PLATE, !0);
u.default.instance.updateInput(r.default.GAMESTATE.OPEN_PLATE);
break;

case "receiveMessage":
m.default.instance.addChatContent(o);
p.default.instance.playerShowBubbleChat(o);
break;

case "summaryPlayer":
p.default.instance.summaryPlayer(o[0]);
break;

case "vipPlayers":
var i = o[0];
i.length > 0 && p.default.instance.vipPlayer(i);
break;

case "updateRoomTime":
t.timer = o[0];
p.default.instance.updateTimer(t.timer);
break;
...
m.default.instance.onShowChat();
};
e.prototype.playerLeave = function(t) {
t[0] === p.default.instance.getAccountIdIsMe() && this.actBackGame();
};
...
var t = new r.default.ModelsSignalr();
t.M = "ExitLobby";
t.A = [];
d.default.getInstance().send(t);
d.default.getInstance().close();
r.default.GameData.getInstance().setDefaultData({});
lngui.UIScreenManager.instance.popToRootScreen2();
};
e.prototype.onDestroy = function() {
l.default.App.ACCESS_TOKEN = null;
};
var o;
e.instance = null;
s([ I(cc.Sprite) ], e.prototype, "spriteSound", void 0);
s([ I([ cc.SpriteFrame ]) ], e.prototype, "sfSounds", void 0);
s([ I(cc.Sprite) ], e.prototype, "spriteBack", void 0);
s([ I(m.default) ], e.prototype, "nodeChat", void 0);
s([ I(c.default) ], e.prototype, "MsgSystem", void 0);
s([ I(cc.Node) ], e.prototype, "NodeTooltip", void 0);
s([ I(cc.Label) ], e.prototype, "lbMsg", void 0);
s([ I(f.default) ], e.prototype, "popupSoiCau", void 0);
s([ I(a.default) ], e.prototype, "popupConfirm", void 0);
s([ I(c.default) ], e.prototype, "popupRules", void 0);
s([ I(S.default) ], e.prototype, "popupHistory", void 0);
s([ I(g.default) ], e.prototype, "popupTopRank", void 0);
s([ I(b.default) ], e.prototype, "popoupPlayersNotInGame", void 0);
s([ I(y.default) ], e.prototype, "popupMaxBet", void 0);
return o = s([ C ], e);
}(cc.Component);
o.default = T;
cc._RF.pop();
...
"./Sb.InfoView": "Sb.InfoView",
"./Sb.InputView": "Sb.InputView",
"./Sb.ResultView": "Sb.ResultView",
"./network/Sb.NetWorkClient": "Sb.NetWorkClient",
"./popup/Sb.GraphView": "Sb.GraphView",
"./popup/Sb.History": "Sb.History",
"./popup/Sb.MaxBet": "Sb.MaxBet",
"./popup/Sb.PlayersNotInGame": "Sb.PlayersNotInGame",
"./popup/Sb.TopRank": "Sb.TopRank",
"./popup/chat/Sb.ChatController": "Sb.ChatController"
} ],
"Sb.GrahpDiceSumView": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "f46e6Avlx1HAbKIPGXcHUbX", "Sb.GrahpDiceSumView");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
s.children[0].getComponent(cc.Sprite).spriteFrame = this.sfTaiXiu[t.Result - 3];
};
e.prototype.strokeLine = function() {
if (!(this.drawPoints.length < 2)) for (var t = 1; t < this.drawPoints.length; t++) {
var e = this.drawPoints[t], o = this.drawPoints[t - 1];
this.drawing.moveTo(o.x, o.y);
this.drawing.lineTo(e.x, e.y);
this.drawing.stroke();
}
};
...
"Sb.GraphCatCauView": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "9aef9/xoaVMT7w6d2OmSjCC", "Sb.GraphCatCauView");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../Sb.InfoView"), c = cc._decorator, r = c.ccclass, l = c.property, p = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.nodeParent = null;
...
var a = o.ChipsData.toString().split(","), c = -1;
if (a[0] == a[1] && a[0] == a[2]) {
c = 2;
t.countBao++;
} else 0 == (c = o.Result < 11 ? 0 : 1) ? t.countXiu++ : t.countTai++;
if (s.length == e.maxItemPerCol) {
n.push(s);
(s = []).push(o);
i = c;
} else if (c == i) s.push(o); else {
n.push(s);
i = c;
(s = []).push(o);
}
...
i.setContentSize(cc.size(37, 37));
var n;
n = o[0] == o[1] && o[0] == o[2] ? "BÃO" : t.Result < 11 ? "XỈU" : "TÀI";
this.lbSessionID.string = "#" + t.SessionID;
this.lbResult.string = n + " " + t.Result + " (" + o[0] + "-" + o[1] + "-" + o[2] + ")";
};
e.prototype.resetDraw = function() {
for (var t = this.nodeParent.children, e = t.length - 1; e >= 0; e--) this.nodeParent.removeChild(t[e]);
};
...
s([ l(cc.Label) ], e.prototype, "lbSessionID", void 0);
s([ l(cc.Label) ], e.prototype, "lbResult", void 0);
s([ l([ cc.SpriteFrame ]) ], e.prototype, "sfTaiXiu", void 0);
return o = s([ r ], e);
}(cc.Component);
o.default = p;
cc._RF.pop();
...
"Sb.GraphDice3View": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "7e20bPxUVBPKJCsnCiPp/vH", "Sb.GraphDice3View");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
e.prototype.draw = function(t) {
this.cacheList = t;
this.drawDiceLine(t, 0, this.drawing1, this.nodeDice1Temp, this.nodeGraphics1);
this.drawDiceLine(t, 1, this.drawing2, this.nodeDice2Temp, this.nodeGraphics2);
this.drawDiceLine(t, 2, this.drawing3, this.nodeDice3Temp, this.nodeGraphics3);
};
e.prototype.createNode = function(t, e, o, i, n) {
t === this.drawing1 ? this.rootPosX = 499 : this.rootPosX = 476;
var s = this.rootPosX - o * this.spaceX, a = this.rootPosY + (e - this.minSum) * this.spacePoint;
0 === o && t.moveTo(s, a);
this.drawPoints.push(cc.v2(s, a));
if (n) {
...
e.prototype.drawDiceLine = function(t, e, o, i, n) {
this.drawPoints = [];
for (var s = 0; s < t.length; s++) {
var a = t[s].ChipsData.split(",");
this.createNode(o, parseInt(a[e]), s, n, i);
}
this.strokeLine(o);
};
e.prototype.strokeLine = function(t) {
if (0 !== this.drawPoints.length) {
t.moveTo(this.drawPoints[0].x, this.drawPoints[0].y);
for (var e = 1; e < this.drawPoints.length; e++) t.lineTo(this.drawPoints[e].x, this.drawPoints[e].y);
t.stroke();
for (var o = 0, i = this.drawPoints; o < i.length; o++) {
var n = i[o];
t.circle(n.x, n.y, this.circleRadian);
t.fill();
}
}
};
...
this.drawing2.clear();
this.drawing3.clear();
this.nodeGraphics1.removeAllChildren();
this.nodeGraphics2.removeAllChildren();
this.nodeGraphics3.removeAllChildren();
};
var o;
e.instance = null;
...
"Sb.GraphView100": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "8b133LvGddLsol7cGZ5OMNq", "Sb.GraphView100");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
"Sb.GraphView": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "6788bdSwKJB9I9c2y4FjJVm", "Sb.GraphView");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../../framework/common/Dialog"), c = t("../Sb.InfoView"), r = t("./graphView/Sb.GrahpDiceSumView"), l = t("./graphView/Sb.GraphCatCauView"), p = t("./graphView/Sb.GraphDice3View"), u = t("./graphView/Sb.GraphView100"), h = cc._decorator, d = h.ccclass, f = h.property, S = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
this.sicboGraphDiceSumView.draw(c.default.instance.getListSoiCau());
this.sicboGraphDice3View.draw(c.default.instance.getListSoiCau());
...
var o;
e.instance = null;
s([ f(u.default) ], e.prototype, "sicboGraph100View", void 0);
s([ f(l.default) ], e.prototype, "sicboGraphCatCuaView", void 0);
s([ f(r.default) ], e.prototype, "sicboGraphDiceSumView", void 0);
s([ f(p.default) ], e.prototype, "sicboGraphDice3View", void 0);
...
"../../../framework/common/Dialog": void 0,
"../Sb.InfoView": "Sb.InfoView",
"./graphView/Sb.GrahpDiceSumView": "Sb.GrahpDiceSumView",
"./graphView/Sb.GraphCatCauView": "Sb.GraphCatCauView",
"./graphView/Sb.GraphDice3View": "Sb.GraphDice3View",
"./graphView/Sb.GraphView100": "Sb.GraphView100"
} ],
"Sb.History": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "74cf3qhrYxPL5PucfE+MTtL", "Sb.History");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../../framework/common/Dialog"), c = t("../../../framework/common/Utils"), r = t("../Sb.Assets"), l = t("../Sb.Common"), p = t("../Sb.Config"), u = t("../Sb.Controller"), h = t("../network/Sb.Http"), d = cc._decorator, f = d.ccclass, S = d.property, y = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = null;
...
this.content.removeAllChildren();
this.template.active = !1;
h.default.sendRequest("GET", p.default.App.HOST_SICBO.host, "api/sicbo/GetHistory?page=" + this.page, null, function(o, i) {
...
var a = cc.instantiate(t.template), p = n[s].ChipsData.split(","), h = n[s].GateID;
s % 2 == 0 && (a.children[0].active = !1);
a.children[1].getComponent(cc.Label).string = "#" + n[s].SessionID;
a.children[2].getComponent(cc.Label).string = n[s].CreateTimeFm;
a.children[3].getComponent(cc.Label).string = l.default.Utils.getInstance().convertGateIdToName(h);
a.children[4].getComponent(cc.Label).string = c.default.formatNumber(n[s].Bet);
a.children[5].getComponent(cc.Label).string = c.default.formatNumber(n[s].Award);
a.children[6].children[0].getComponent(cc.Sprite).spriteFrame = r.default.instance.getSprDicesV2(parseInt(p[0]));
a.children[6].children[1].getComponent(cc.Sprite).spriteFrame = r.default.instance.getSprDicesV2(parseInt(p[1]));
a.children[6].children[2].getComponent(cc.Sprite).spriteFrame = r.default.instance.getSprDicesV2(parseInt(p[2]));
a.active = !0;
a.parent = e.content;
}
...
s([ S(cc.Node) ], e.prototype, "content", void 0);
s([ S(cc.Node) ], e.prototype, "template", void 0);
s([ S(cc.Label) ], e.prototype, "lblPage", void 0);
s([ S(cc.Node) ], e.prototype, "btnNext", void 0);
s([ S(cc.Node) ], e.prototype, "btnBack", void 0);
return s([ f ], e);
}(a.default);
o.default = y;
cc._RF.pop();
...
"../Sb.Config": "Sb.Config",
"../Sb.Controller": "Sb.Controller",
"../network/Sb.Http": "Sb.Http"
} ],
"Sb.Http": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "2c493ReDAVLLalhCHhAAxbr", "Sb.Http");
...
var n = t("../Sb.Config"), s = cc._decorator, a = s.ccclass, c = (s.property, function() {
function t() {}
t.sendRequest = function(t, e, o, i, s) {
var a = n.default.App.USE_WSS ? "https://" : "http://", c = cc.loader.getXMLHttpRequest();
a = a + e + "/" + o;
...
cc.sys.isNative || (c.withCredentials = !0);
...
s(e, t);
} else 200 !== c.status && s(c.status, null);
};
var r = null;
if (i) {
r = JSON.stringify(i);
...
"Sb.InfoView": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "cb9e58YOkFLtZKjg30+toEm", "Sb.InfoView");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../framework/common/Utils"), c = t("./Sb.Assets"), r = t("./Sb.Common"), l = t("./Sb.InputView"), p = t("./Sb.Player"), u = cc._decorator, h = u.ccclass, d = u.property, f = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.lbSID = null;
...
this.listDiceHisoty[0].spriteFrame = c.default.instance.getSprDicesV2(parseInt(i));
this.listDiceHisoty[1].spriteFrame = c.default.instance.getSprDicesV2(parseInt(n));
this.listDiceHisoty[2].spriteFrame = c.default.instance.getSprDicesV2(parseInt(s));
...
t.listNodeSoiCau[o].spriteFrame = c.default.instance.getSprNodeDice(e);
});
};
...
"Sb.InputView": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "1aa2fAsPgdPCLrcxF/htKBR", "Sb.InputView");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../framework/common/Utils"), c = t("./Sb.Assets"), r = t("./Sb.ChipItem"), l = t("./Sb.ChipPool"), p = t("./Sb.Common"), u = t("./Sb.Controller"), h = t("./Sb.InfoView"), d = t("./Sb.ResultView"), f = t("./network/Sb.NetWorkClient"), S = t("./settings/Sb.Settings"), y = t("./Sb.PlayerData"), b = cc._decorator, g = b.ccclass, m = b.property, v = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
this.chipIndex = 1;
this.betValues = [ 1e3, 5e3, 1e4, 5e4, 1e5, 5e5, 1e6 ];
...
S.default.instance.playAudioClip(1);
var n = e, s = l.default.instance.createChip();
s.parent = this.nodeParentChip;
var a;
a = -1 != t ? y.default[t].position : this.posGroupUser;
s.position = a;
var c = s.getComponent(r.default);
c.betIndex = n;
c.gate = e;
c.playerId = t;
c.position = a;
c.setChip(o);
this.gateChips[e].push(c);
var p = d.default.instance.getPositionFromGate(n);
p.y = p.y + this.gateChips[e].length - 1 - 70;
if (i) c.moveTo(cc.v2(p.x, p.y), e); else {
c.setPosition(cc.v2(p.x, p.y));
...
var e = l.default.instance.createChip();
...
var i = d.default.instance.getPositionFromGate(t.gate);
i.y = i.y - 60;
var n = i.x - 5, s = i.x + 5, a = i.y - 7, c = i.y + 7, p = n + Math.floor(Math.random() * Math.abs(s - n)), u = a + Math.floor(Math.random() * Math.abs(c - a));
o.moveTo(cc.v2(p, u));
};
...
var o = this.rootDealerPos.x - 20, i = this.rootDealerPos.x + 20, n = this.rootDealerPos.y + 5, s = this.rootDealerPos.y + 15, a = o + Math.floor(Math.random() * Math.abs(i - o)), c = n + Math.floor(Math.random() * Math.abs(s - n));
t.moveToEndStop(cc.v2(a, c), e);
};
e.prototype.betValueClicked = function(t, e) {
S.default.instance.playAudioClip(0);
this.chipIndex = parseInt(e);
this.processBetValUI();
};
e.prototype.betClicked = function(t, e) {
if (u.default.instance.timer <= 3) u.default.instance.showMsg("Hết thời gian đặt cược..."); else {
var o = parseInt(e), i = this.betValues[this.chipIndex];
if (h.default.instance.me.userInfo.Balance < i) cc.find("Canvas/popupView-noHide").getComponent("PopupView").showPopupShopRequire(); else {
d.default.instance.nodeFxGateClick(o);
this.isRebet = !1;
var n = new p.default.ModelsSignalr();
n.M = "Bet";
n.A = [ i, o ];
f.default.getInstance().send(n);
}
}
};
e.prototype.nanClicked = function() {
this.isNan = !this.isNan;
this.isNan ? this.sprNan.spriteFrame = c.default.instance.getSprNan(0) : this.sprNan.spriteFrame = c.default.instance.getSprNan(1);
};
e.prototype.actCoppy = function() {
this.currentState == p.default.GAMESTATE.BETTING ? a.default.copyToClipboard(h.default.instance.resultBetting) : a.default.copyToClipboard(h.default.instance.resultKey);
u.default.instance.showMsg("Sao chép chuỗi thành công!");
};
...
} else u.default.instance.showMsg("Không có dữ liệu phiên trước...");
}
};
...
d.default.instance.nodeGateDisabeClick(t);
};
...
if (h.default.instance.getPositions()) {
var e = t[0], o = t[1], i = t[2], n = t[3];
h.default.instance.updateChip(e, n);
this.playFxUserBet(h.default.instance.getIndexUIBetByAccID(e), i, this.getChipIndexFromValue(o), !0);
if (i == p.default.GATE.TAI || i == p.default.GATE.XIU) {
this.totalBets[i] += o;
this.lbTotalBets[i].string = a.default.nFormatter(this.totalBets[i]);
}
if (e == h.default.instance.getAccountIdIsMe()) {
this.logSessionId < h.default.instance.getSessionId() && (this.logBets = []);
this.logBets.push({
AccountID: e,
Amount: o,
Gate: i
...
this.logSessionId = h.default.instance.getSessionId();
}
}
};
...
if (e > h.default.instance.me.userInfo.Balance) cc.find("Canvas/popupView-noHide").getComponent("PopupView").showPopupShopRequire(); else {
var o = 0, i = this.logBets;
this.isRebet = !0;
i.forEach(function(e) {
t.arrTimeoutBet.push(setTimeout(function() {
if (t.node && t.node.active && t.currentState == p.default.GAMESTATE.BETTING && t.node && t.node.active) {
e.Amount = e.Amount;
...
if (h.default.instance.me.userInfo.Balance < t.Amount) cc.find("Canvas/popupView-noHide").getComponent("PopupView").showPopupShopRequire(); else {
var e = new p.default.ModelsSignalr();
e.M = "Bet";
e.A = [ t.Amount, t.Gate ];
f.default.getInstance().send(e);
}
};
...
t.forEach(function(t) {
t.forEach(function(t) {
e.playFxUserBet(h.default.instance.getIndexUIBetByAccID(t.AccountID), t.BetSide, e.getChipIndexFromValue(t.BetValue), !1);
if (t.BetSide == p.default.GATE.TAI || t.BetSide == p.default.GATE.XIU) {
e.totalBets[t.BetSide] += t.BetValue;
e.lbTotalBets[t.BetSide].string = a.default.nFormatter(e.totalBets[t.BetSide]);
}
if (t.AccountID == h.default.instance.getAccountIdIsMe()) {
(0 != e.logSessionId && e.logSessionId < h.default.instance.getSessionId() || e.isRebet) && (e.logBets = []);
e.logBets.push({
...
e.logSessionId = h.default.instance.getSessionId();
}
});
});
};
...
switch (t) {
case p.default.GAMESTATE.BETTING:
if (this.currentState !== t) {
this.clearAllTimeOut();
this.resetTotalBetUI();
this.activeAllButtonBet(!0);
u.default.instance.showMsg("Xin mời đặt cược...");
}
this.currentState == t && 3 == u.default.instance.timer && u.default.instance.showMsg("Dừng cược nha...");
break;

case p.default.GAMESTATE.OPEN_PLATE:
if (this.currentState !== t) {
this.clearAllTimeOut();
...
case p.default.GAMESTATE.SHOW_RESULT:
this.currentState !== t && this.activeAllButtonBet(!1);
break;

case p.default.GAMESTATE.WAITING:
if (this.currentState !== t) {
this.activeAllButtonBet(!1);
...
case p.default.GAMESTATE.SHAKING:
if (this.currentState !== t) {
this.resetTotalBetUI();
this.activeAllButtonBet(!1);
}
...
if (p.default.GAMESTATE.BETTING) {
this.NodeMyBet[t[0].BetSide].active = !0;
this.NodeMyBet[t[0].BetSide].getChildByName("txtMyBets").getComponent(cc.Label).string = a.default.nFormatter(t[0].SumaryBet);
...
"../../framework/common/Utils": void 0,
"./Sb.Assets": "Sb.Assets",
"./Sb.ChipItem": "Sb.ChipItem",
"./Sb.ChipPool": "Sb.ChipPool",
"./Sb.Common": "Sb.Common",
"./Sb.Controller": "Sb.Controller",
"./Sb.InfoView": "Sb.InfoView",
"./Sb.PlayerData": "Sb.PlayerData",
"./Sb.ResultView": "Sb.ResultView",
"./network/Sb.NetWorkClient": "Sb.NetWorkClient",
"./settings/Sb.Settings": "Sb.Settings"
} ],
"Sb.Loading": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "ae63c7ux7pMEruRUZXu4CVk", "Sb.Loading");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
if (this.progressBar.node.parent.active) {
if (this.progressBar.progress >= 1) {
this.isJoinGame || this.onJoinRoom();
return;
}
...
"Sb.MaxBet": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "35c1dm7sGdDc6o9RanMH75Z", "Sb.MaxBet");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
"Sb.NetWorkClient": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "a878auNX9dM7Zwj+0Nc4Ve3", "Sb.NetWorkClient");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var s = t("../Sb.Common"), a = t("../Sb.Config"), c = t("./Sb.Http"), r = t("./Sb.Network.Clients"), l = t("./Sb.Network.Service"), p = function() {
this.M = null;
this.A = null;
this.H = null;
this.I = null;
...
var o = this;
c.default.sendRequest("GET", a.default.App.HOST_SICBO.host, "/signalr/negotiate", null, function(t, i) {
if (null == t) {
...
t.prototype.connect.call(this, a.default.App.HOST_SICBO.host, null);
};
e.prototype.reConnect = function() {
this.isReconnect = !0;
t.prototype.connect.call(this, a.default.App.HOST_SICBO.host, null);
...
var t = new p();
t.M = "EnterLobby";
t.A = [ s.default.Utils.getInstance().getDeviceType(), a.default.App.VIP_PLAYER ];
this.send(t);
};
...
var s = this.services[n];
if (s.target && s.target instanceof Object && s.target.node) {
s.callback(o.M, i);
e.M && e.M.length > 1 && e.M.forEach(function(t) {
"" != t.M && s.callback(t.M, t.A);
});
if (!this.isLogin && null != s.cbLogin) {
this.isLogin = !0;
s.cbLogin();
}
} else {
...
} else if (e.R && e.R.AccountID) this.sendPlayNow(); else if (e.R && e.I === this.lastID.toString()) {
this.lastID = 0;
lngui.UIWaitingLayout.hideWaiting();
...
"../Sb.Config": "Sb.Config",
"./Sb.Http": "Sb.Http",
"./Sb.Network.Clients": "Sb.Network.Clients",
"./Sb.Network.Service": "Sb.Network.Service"
} ],
"Sb.Network.Clients": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "c7f1er+599NcKiT5EYTVjql", "Sb.Network.Clients");
Object.defineProperty(o, "__esModule", {
value: !0
});
var i = t("../Sb.Config"), n = t("./Sb.Network.Service"), s = function() {
function t() {
this.ws = null;
this.host = null;
this.port = null;
...
"Sb.Network.Service": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "4d8ff+GyXJHZJscEuxkkq5g", "Sb.Network.Service");
Object.defineProperty(o, "__esModule", {
value: !0
});
...
"Sb.PlayerData": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "83758XYCQdEK50QnK/LTecL", "Sb.PlayerData");
Object.defineProperty(o, "__esModule", {
value: !0
});
var i = [ {
...
"Sb.PlayersNotInGame": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "1690bxYlm5MSrElqWTD2zK9", "Sb.PlayersNotInGame");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
s.children[1].getComponent(cc.Label).string = l.default.Utils.getInstance().formatName(o[i].Account.NickName);
s.children[2].getComponent(cc.Label).string = c.default.formatNumber(o[i].Account.Balance);
n.active = !0;
...
this.content.removeAllChildren();
this.template.active = !1;
h.default.sendRequest("GET", p.default.App.HOST_SICBO.host, "api/sicbo/GetPlayersNotInGame", null, function(e, o) {
if (e) {
t.onClose();
u.default.instance.showMsg("Hệ thống đang bận, vui lòng tải lại sau!");
} else {
...
"Sb.Player": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "72f343NfGJCgK2ZE++JfiI7", "Sb.Player");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../framework/common/Utils"), c = t("./Sb.Assets"), r = t("./Sb.Common"), l = t("./Sb.InfoView"), p = cc._decorator, u = p.ccclass, h = p.property, d = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.lbSID = null;
...
this.userInfo = t;
this.avatar.getComponent(cc.Sprite).spriteFrame = c.default.instance.getSprAvatar(this.userInfo.Avatar);
...
this.avatar.getComponent(cc.Sprite).spriteFrame = c.default.instance.getSprAvatar(0);
this.nodeInfo.active = !1;
};
...
"Sb.ResultView": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "48c11NvdfpJEZmUxxm2vMPl", "Sb.ResultView");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("./Sb.Common"), c = t("./Sb.Controller"), r = t("./Sb.InfoView"), l = t("./Sb.InputView"), p = cc._decorator, u = p.ccclass, h = p.property, d = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.nodeBatNan = null;
...
this.positionDefaultDia = cc.v2(0, 190);
this.animationXocXoc = this.animationBat.children[0].getComponent(sp.Skeleton);
this.animationMoBat = this.animationBat.children[0].getComponent(sp.Skeleton);
};
...
cc.moveTo(.5, this.getPositionRootDia()), cc.scaleTo(1.2, 1.2);
this.animationBat.stopAllActions();
break;

case a.default.GAMESTATE.OPEN_PLATE:
cc.moveTo(.5, this.getPositionDiaShaking()), cc.scaleTo(.5, 1);
this.animationBat.stopAllActions();
break;

case a.default.GAMESTATE.SHAKING:
var e = this.getPositionRootDia();
cc.moveTo(.5, e), cc.scaleTo(.5, .5);
this.animationBat.stopAllActions();
}
};
...
this.animationMoBat.setAnimation(1, "Idle", !1);
...
if (s.node && s.node.active) {
if (c.default && !c.default.instance.node) return;
s.nodeDia.active = !0;
s.nodeViParent.active = !0;
s.resultNormal = e;
setTimeout(function() {
!(s.node && s.node.active && c.default) || c.default.instance.node;
}, 4500);
}
...
setTimeout(function() {
if (s.node && s.node.active) {
s.playFxResult(e, o, n);
var t = e.Dice1 + "-" + e.Dice2 + "-" + e.Dice3;
parseInt(e.Dice1 + e.Dice2 + e.Dice3) < 11 ? c.default.instance.showMsg(t + " XỈU") : c.default.instance.showMsg(t + " TÀI");
}
}, 1e3);
setTimeout(function() {
if (s.node && s.node.active) {
s.nodeDia.runAction(cc.spawn(cc.scaleTo(.5, .8), cc.moveTo(.5, cc.v2(0, 0)), cc.callFunc(function() {
setTimeout(function() {
s.animationMoBat.setAnimation(1, "Open", !1);
r.default.instance.disPlayStringResult(r.default.instance.resultKey);
}, 1e3);
})));
s.animationDice.runAction(cc.spawn(cc.scaleTo(.5, 1.5), cc.moveTo(.5, cc.v2(0, -570))));
}
}, 2e3);
}
}, 1500);
...
this.nodeFxDisableAll();
this.animationMoBat.setAnimation(1, "Close", !1);
setTimeout(function() {
s.nodeDia.runAction(cc.spawn(cc.scaleTo(.5, .2), cc.moveTo(.5, cc.v2(0, 190)), cc.callFunc(function() {})));
s.animationDice.runAction(cc.spawn(cc.scaleTo(.5, .4), cc.moveTo(.5, cc.v2(0, -203))));
}, 1e3);
this.updateDice(e);
setTimeout(function() {
c.default && !c.default.instance.node || s.playFXMoveDia(a.default.GAMESTATE.OPEN_PLATE);
}, 2e3);
}
break;
...
this.nodeResult.active = !1;
this.nodeFxDisableAll();
this.getPositionDiaShaking().x, this.getPositionDiaShaking().y;
this.animationXocXoc.node.position.x = 0;
this.animationXocXoc.node.position.y = 293;
setTimeout(function() {
c.default && !c.default.instance.node || s.playFXMoveDia(i);
}, 2500);
}
}
this.currentState = i;
...
parseInt(this.resultNormal.Dice1 + this.resultNormal.Dice2 + this.resultNormal.Dice3) < 11 ? c.default.instance.showMsg(e + " XỈU") : c.default.instance.showMsg(e + " TÀI");
setTimeout(function() {
c.default && !c.default.instance.node || t.nodeDia.runAction(cc.spawn(cc.scaleTo(.5, .5), cc.moveTo(.5, t.getPositionRootDia()), cc.callFunc(function() {
t.animationMoBat.setAnimation(1, "Idle", !0);
t.animationBat.position.x = 0;
t.animationBat.position.y = 293;
...
if (t) {
var i = e.split(",");
i && i.length > 1 && i.forEach(function(t) {
...
var n = e.split(",");
n && n.length > 1 && n.forEach(function(t) {
...
var o = this, i = e.GatesData, n = e.GatesLose, s = i.split(","), a = n.split(",");
this.fxMoveChip(a, 0);
setTimeout(function() {
c.default && !c.default.instance.node || o.fxMoveChip(s, 1);
}, 1500);
setTimeout(function() {
c.default && !c.default.instance.node || o.fxMoveChip(s, 2);
}, 2500);
};
...
var o;
s([ h(cc.Node) ], e.prototype, "nodeBatNan", void 0);
s([ h(cc.Node) ], e.prototype, "nodeDia", void 0);
s([ h(cc.Node) ], e.prototype, "animationBat", void 0);
s([ h(cc.Node) ], e.prototype, "animationDice", void 0);
s([ h([ cc.Sprite ]) ], e.prototype, "spriteVis", void 0);
s([ h([ cc.SpriteFrame ]) ], e.prototype, "sfVis", void 0);
s([ h(cc.Animation) ], e.prototype, "animResult", void 0);
s([ h([ cc.Node ]) ], e.prototype, "allNodeGate", void 0);
return o = s([ u ], e);
}(cc.Component);
o.default = d;
cc._RF.pop();
...
"Sb.SessionInfo": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "9eb6eZGo91DPZa1xLVyDzQS", "Sb.SessionInfo");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../../framework/common/Dialog"), c = cc._decorator, r = c.ccclass, l = (c.property, 
function(t) {
n(e, t);
function e() {
...
"Sb.Settings": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "2643aixrSZE/JEQCWziSodJ", "Sb.Settings");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../Sb.Controller"), c = cc._decorator, r = c.ccclass, l = c.property, p = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.sprMusic = [];
...
this.isOpenMenu = !0;
this.node.stopAllActions();
(e = cc.moveTo(.5, cc.v2(-670, 0))).easing(cc.easeQuadraticActionInOut());
var t = cc.callFunc(this.onShowFinish.bind(this), null);
this.node.runAction(cc.sequence(e, t));
} else {
this.isOpenMenu = !1;
...
a.default.instance.popupSoiCau.show();
};
...
this.onSelectMenu();
a.default.instance.popupRules.show();
};
e.prototype.selectHistoryGame = function() {
this.onSelectMenu();
a.default.instance.popupHistory.onShow();
};
e.prototype.selectTopRankGame = function() {
this.onSelectMenu();
a.default.instance.popupTopRank.onShow();
};
e.prototype.selectMaxBet = function() {
this.onSelectMenu();
a.default.instance.popupMaxBet.onShow();
};
e.prototype.selectSessionInfo = function() {
this.onSelectMenu();
};
e.prototype.selectPlayerNotInGame = function() {
a.default.instance.popoupPlayersNotInGame.onShow();
};
...
"Sb.TopRank": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "c6c29eYEuxOs7eRhdh9ddhX", "Sb.TopRank");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("../../../framework/common/Dialog"), c = t("../../../framework/common/Utils"), r = t("../Sb.Config"), l = t("../Sb.Controller"), p = t("../network/Sb.Http"), u = cc._decorator, h = u.ccclass, d = u.property, f = function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = null;
...
this.content.removeAllChildren();
this.template.active = !1;
p.default.sendRequest("GET", r.default.App.HOST_SICBO.host, "api/sicbo/GetBigWinner", null, function(o, i) {
lngui.UIWaitingLayout.hideWaiting();
if (o) {
e.onClose();
l.default.instance.showMsg("Hệ thống đang bận, vui lòng tải lại sau!");
} else for (var n = i, s = 0; s < n.length; s++) {
var a = cc.instantiate(t.template), r = s + 1;
s % 2 == 0 && (a.children[0].active = !1);
if (1 == r) {
a.children[1].color = cc.Color.YELLOW;
a.children[2].color = cc.Color.YELLOW;
} else if (2 == r) {
a.children[1].color = cc.Color.GREEN;
a.children[2].color = cc.Color.GREEN;
} else if (3 == r) {
a.children[1].color = cc.Color.BLUE;
a.children[2].color = cc.Color.BLUE;
}
a.children[1].getComponent(cc.Label).string = r.toString();
a.children[2].getComponent(cc.Label).string = n[s].DisplayName;
a.children[3].getComponent(cc.Label).string = c.default.formatNumber(n[s].Award);
a.active = !0;
a.parent = e.content;
}
});
...
"Sb.TouchMove": [ function(t, e, o) {
"use strict";
cc._RF.push(e, "768ee1qCQdBgZgC1gQHWD3A", "Sb.TouchMove");
var i, n = this && this.__extends || (i = function(t, e) {
return (i = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var a = t("./Sb.ResultView"), c = cc._decorator, r = c.ccclass, l = (c.property, 
function(t) {
n(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
this.node.position = cc.v3(this.lastX, this.lastY);
};
e.prototype.callbackNanSuccess = function() {
this.x = this.lastX;
this.y = this.lastY;
...
}, {}, [ "Sb.Assets", "Sb.ChipItem", "Sb.ChipPool", "Sb.Common", "Sb.Config", "Sb.Controller", "Sb.InfoView", "Sb.InputView", "Sb.Loading", "Sb.Player", "Sb.PlayerData", "Sb.ResultView", "Sb.TouchMove", "Sb.Http", "Sb.NetWorkClient", "Sb.Network.Clients", "Sb.Network.Service", "Sb.GraphView", "Sb.History", "Sb.MaxBet", "Sb.PlayersNotInGame", "Sb.SessionInfo", "Sb.TopRank", "Sb.ChatController", "Sb.ChatListView", "Sb.GrahpDiceSumView", "Sb.GraphCatCauView", "Sb.GraphDice3View", "Sb.GraphView100", "Sb.Settings" ]);