...
var i = (this.node.y, this.mSlot.mSlotConfig.DISTANCE), n = this.mSlotRoom.mIsQuickSpin ? this.mSlot.mSlotConfig.TIME_MOVE_ITEM_START_QUICK : this.mSlot.mSlotConfig.TIME_MOVE_ITEM_START;
i = 3 == this.mSlotReel.mId || 4 == this.mSlotReel.mId || 5 == this.mSlotReel.mId ? this.node.y - 3 * this.mSlot.mSlotConfig.DISTANCE2 : this.node.y - 3 * this.mSlot.mSlotConfig.DISTANCE;
this.node.stopAllActions();
...
var i = (this.node.y, this.mSlot.mSlotConfig.DISTANCE), n = this.mSlotRoom.mIsQuickSpin ? this.mSlot.mSlotConfig.TIME_MOVE_ITEM_QUICK : this.mSlot.mSlotConfig.TIME_MOVE_ITEM;
i = 3 == this.mSlotReel.mId || 4 == this.mSlotReel.mId || 5 == this.mSlotReel.mId ? this.node.y - 3 * this.mSlot.mSlotConfig.DISTANCE2 : this.node.y - 3 * this.mSlot.mSlotConfig.DISTANCE;
this.node.stopAllActions();
this.node.runAction(cc.sequence(cc.moveTo(n, o.node.x, i), cc.callFunc(function() {
o.reset();
...
var e = (this.node.y, this.mSlot.mSlotConfig.DISTANCE), i = this.mSlotRoom.mIsQuickSpin ? this.mSlot.mSlotConfig.TIME_MOVE_STOP_ITEM_QUICK : this.mSlot.mSlotConfig.TIME_MOVE_STOP_ITEM;
e = 3 == this.mSlotReel.mId || 4 == this.mSlotReel.mId || 5 == this.mSlotReel.mId ? this.node.y - 3 * this.mSlot.mSlotConfig.DISTANCE2 - 140 : this.node.y - 3 * this.mSlot.mSlotConfig.DISTANCE - 80;
this.node.stopAllActions();
...
var o = -1;
1 == t ? o = 0 : 3 == t ? o = 1 : 4 == t ? o = 2 : 5 == t ? o = 3 : 6 == t ? o = 4 : 7 == t ? o = 5 : 8 == t ? o = 6 : 9 == t ? o = 7 : 0 != t && 10 != t || (o = 8);
this.skeItem.skeletonData = this.mSlot.mSlotConfig.LIST_SKE_ITEM[o];
1 == t ? this.skeItem.setAnimation(0, "idle", !0) : this.skeItem.setAnimation(0, "idle", !1);
};
o.prototype.setFrameItem = function() {};
...
var s = t("../../base_slot/Slot"), r = t("../../base_slot/SlotConstant"), c = t("./Slot3x3x2Room"), a = t("./Slot3x3x2Var"), p = cc._decorator, h = p.ccclass, u = p.property, m = function(t) {
n(o, t);
function o() {
var o = null !== t && t.apply(this, arguments) || this;
o.mSlotNetwork = null;
...
this.mIdGame = r.GAME_ID.GODZILLA;
...
l([ u(c.default) ], o.prototype, "mSlotRoom", void 0);
