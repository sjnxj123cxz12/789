...
if (lngui.UserManager.instance.mainUserInfo.Money < this.balanceBet) cc.PopupController.getInstance().showPopupShopRequire(); else {
...
this.dragonTigerGraphCard3View.draw(e);
},
pageEvent: function() {
this.checkStatusButton();
},
