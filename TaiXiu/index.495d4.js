...
var c = t("./Tx.MainGame"), s = cc._decorator, r = s.ccclass, l = (s.property, function(t) {
o(e, t);
function e() {
...
c.default.instance.showScoreNam();
};
return a([ r ], e);
}(cc.Component));
i.default = l;
...
var c = t("../Tx.Chat"), s = t("../Tx.Const"), r = cc._decorator, l = r.ccclass, u = (r.property, 
function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
cc.systemEvent.off(s.TxConst.CHAT_TAIXIU_SOCKET_EVENT, this.onResponeData, this);
cc.systemEvent.on(s.TxConst.CHAT_TAIXIU_SOCKET_EVENT, this.onResponeData, this);
this.mSignalr = new lngui.GateSignalR();
this.mSignalr.connect(s.TxConst.CHAT_TAIXIU_SOCKET_EVENT, t.url, t.hub, lngui.UserManager.instance.mainUserInfo.cookie, !1);
...
var c = t("./network/Tx.Chat.NetworkClient"), s = cc._decorator, r = s.ccclass, l = s.property, u = function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
var c = t("./network/Tx.NetworkClient"), s = t("./Tx.Const"), r = cc._decorator, l = r.ccclass, u = r.property, h = function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
e.prototype.onLoad = function() {
i._instance = this;
c.default.instance.sendSignalR("GetSessionResultHistory", [ s.TxConst.diceNode.GameSessionID ]);
...
this.m_GameSessionID >= s.TxConst.GameSessionID ? this.m_GameSessionID = s.TxConst.GameSessionID - 1 : c.default.instance.sendSignalR("GetSessionResultHistory", [ this.m_GameSessionID ]);
};
...
this.m_GameSessionID < s.TxConst.GameSessionID - 15 ? this.m_GameSessionID = s.TxConst.GameSessionID - 15 : c.default.instance.sendSignalR("GetSessionResultHistory", [ this.m_GameSessionID ]);
};
...
if (this.m_coinData[0].LocationWinID == s.TxConst.BetGate.GATE_TAI) {
this.imgEffectTai.active = !0;
this.imgEffectXiu.active = !1;
} else if (this.m_coinData[0].LocationWinID == s.TxConst.BetGate.GATE_XIU) {
this.imgEffectTai.active = !1;
...
e.prototype.onEnable = function() {
i._instance = this;
c.default.instance.sendSignalR("GetAccountHistory", [ s.TxConst.BetType.BET_GOLD, s.TxConst.GameID.TAI_XIU, 30 ]);
};
...
if (n.length > 0) {
var m = s.TxConst.formatDateTime2(n);
p.getChildByName("txtThoiGian").getComponent(cc.Label).string = m;
p.getChildByName("txtThoiGian").color = cc.Color.WHITE;
}
if (h > 0) {
p.getChildByName("txtTienThang").getComponent(cc.Label).string = "+" + s.TxConst.formatNumber(u);
...
p.getChildByName("txtTongCuoc").getComponent(cc.Label).string = s.TxConst.formatNumber(r - l);
p.getChildByName("txtChiTiet").getComponent(cc.Label).string = "Đặt " + o + ". Kết quả " + a + ", Tổng đặt \n" + s.TxConst.formatNumber(r) + " Hoàn trả " + s.TxConst.formatNumber(l) + " Nhận " + s.TxConst.formatNumber(u);
...
var c = t("../Tx.Const"), s = cc._decorator, r = s.ccclass, l = s.property, u = function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.txtPhien = null;
...
this.txtTienNohu.string = c.TxConst.formatNumberMin(m);
this.txtTienNohu.node.color = cc.Color.YELLOW;
this.txtVinhDanh1.string = c.TxConst.formatUserName(a);
this.txtVinhDanh2.string = c.TxConst.formatUserName(s);
this.txtVinhDanh3.string = c.TxConst.formatUserName(r);
this.txtTienTrung1.string = c.TxConst.formatNumberMin(l);
this.txtTienTrung1.horizontalAlign = 2;
this.txtTienTrung2.string = c.TxConst.formatNumberMin(u);
this.txtTienTrung2.horizontalAlign = 2;
this.txtTienTrung3.string = c.TxConst.formatNumberMin(h);
...
var i = t[e], n = i.SessionTime, o = (i.LocationName, i.Result), a = i.Data[0].Username, c = i.Data[1].Username, r = i.Data[2].Username, l = i.Data[0].JackpotValue, u = i.Data[1].JackpotValue, h = i.Data[2].JackpotValue;
...
if (n.length > 0) {
var d = s.TxConst.formatDateTime2(n);
...
g.getChildByName("txtTienNohu").getComponent(cc.Label).string = s.TxConst.convertToMoney(m);
g.getChildByName("txtVinhDanh1").getComponent(cc.Label).string = s.TxConst.formatUserName(a);
g.getChildByName("txtVinhDanh2").getComponent(cc.Label).string = s.TxConst.formatUserName(c);
g.getChildByName("txtVinhDanh3").getComponent(cc.Label).string = s.TxConst.formatUserName(r);
g.getChildByName("txtTienTrung1").getComponent(cc.Label).string = s.TxConst.formatNumbertoK(l);
g.getChildByName("txtTienTrung1").getComponent(cc.Label).horizontalAlign = 2;
g.getChildByName("txtTienTrung2").getComponent(cc.Label).string = s.TxConst.formatNumbertoK(u);
g.getChildByName("txtTienTrung2").getComponent(cc.Label).horizontalAlign = 2;
g.getChildByName("txtTienTrung3").getComponent(cc.Label).string = s.TxConst.formatNumbertoK(h);
...
r.getChildByName("txtTienThuong").getComponent(cc.Label).string = s.TxConst.formatNumbertoK(c);
...
var c = t("./BatNanCtrl"), s = t("./network/Tx.NetworkClient"), r = t("./Tx.Const"), l = cc._decorator, u = l.ccclass, h = l.property, p = function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.m_nGameStatus = 0;
...
var a = e + n + o;
if (e > 0) {
var c = "+" + r.TxConst.formatNumber(parseInt(a));
...
null != this._callback && this._callback(r.TxConst.RETURN_MONEY, c, t);
} else if (n > 0) {
c = "+" + r.TxConst.formatNumber(parseInt(n));
this.m_lblMoneyWin.string = c;
this.m_lblMoneyWin.node.active = !0;
this.m_lblMoneyWin.node.runAction(cc.moveBy(3, cc.v2(0, 40)));
this.node.runAction(cc.sequence(cc.delayTime(3), cc.callFunc(function() {
...
c = "-" + r.TxConst.formatNumber(parseInt(i));
this.m_lblMoneyWin.string = c;
this.m_lblMoneyWin.node.active = !0;
this.m_lblMoneyWin.node.runAction(cc.moveBy(3, cc.v2(0, 40)));
this.node.runAction(cc.sequence(cc.delayTime(3), cc.callFunc(function() {
...
this.m_lblMoneyTai.string = r.TxConst.convertToMoney(s);
...
this.m_llBetValue = 0;
this.keyPadValue = "";
this.m_nGameStatus == r.TxConst.GameStatus.RACING && this.m_nRemainWaiting > 8 && this.m_nRemainWaiting < 24 && (this.m_imgDice1.node.active && this.m_imgDice2.node.active && this.m_imgDice3.node.active || s.default.instance.sendSignalR("GetCurrentResultTaiXiu", []));
}
this.startTimer();
}
};
...
var c = e[a].LocationIDWin, s = cc.instantiate(this.templecau);
s.active = !0;
var l = s.getComponent(cc.Sprite);
this.resultcau = e[a].DiceSum;
c == r.TxConst.BetGate.GATE_TAI ? l.spriteFrame = n : l.spriteFrame = o;
this.m_historyPanel.addChild(s);
s.y = this.firstPosHis.y;
s.x = this.firstPosHis.x - a * this.diceWith;
s.active = !0;
s.width = 34;
s.height = 29;
s.name = e[a].GameSessionID.toString();
s.on(cc.Node.EventType.TOUCH_END, this.touchShowHistoryTurn, this, !0);
if (this.m_nGameStatus == r.TxConst.GameStatus.RACING && 0 == a) {
s.runAction(cc.sequence(cc.scaleTo(.3, .8), cc.scaleTo(.3, 1.1)).repeatForever());
if (c == r.TxConst.BetGate.GATE_TAI) {
s.getChildByName("label").getComponent(cc.Label).string = this.resultcau;
s.getChildByName("label").color = cc.color(255, 255, 255);
} else {
s.getChildByName("label").getComponent(cc.Label).string = this.resultcau;
s.getChildByName("label").color = cc.color(0, 0, 0);
}
}
}
}
...
var c = t("../popup/Tx.History"), s = t("../popup/Tx.VinhDanh"), r = t("../Tx.Const"), l = t("../Tx.HistoryTurn"), u = t("../Tx.MainGame"), h = t("../popup/Tx.Jackpot"), p = cc._decorator, m = p.ccclass, g = (p.property, 
function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
var i = 0, n = 0, o = -1, a = 0, c = t[0].DiceSum;
for (var s in t) {
if (c > 10 && t[s].DiceSum < 11 || c < 11 && t[s].DiceSum > 10) {
c = t[s].DiceSum;
a++;
}
a < 19 && this._arrSC1.push(t[s]);
}
o = -1;
a = 0;
c = this._arrSC1[this._arrSC1.length - 1].DiceSum;
for (var r = this._arrSC1.length - 1; r >= 0; r--) {
if (c > 10 && this._arrSC1[r].DiceSum < 11 || c < 11 && this._arrSC1[r].DiceSum > 10) {
c = this._arrSC1[r].DiceSum;
a++;
o = 0;
} else if (6 == ++o) {
o = 0;
...
l.setPosition(this.getPosforSC1(a, o));
this.pnlSC1.addChild(l);
}
for (var u = 0, h = 0, p = 0, m = 0, g = t.length - 1; g >= 0 && !(h > 18); g--) {
console.log(h);
var d = new cc.Node();
d.scale = .8;
var f = d.addComponent(cc.Sprite), T = null;
if (t[g].DiceSum > 10) {
...
var C = new cc.Node(), b = C.addComponent(cc.Sprite);
e[t[y].DiceSum] && (b.spriteFrame = e[t[y].DiceSum]);
...
v.setPosition(this.getPosforSC3(a, t[y].Dice1));
this.pnlXX1.addChild(v, 2);
var N = new cc.Node();
N.addComponent(cc.Sprite).spriteFrame = this.ballRed;
N.setPosition(this.getPosforSC3(a, t[y].Dice2));
this.pnlXX2.addChild(N, 2);
var S = new cc.Node();
S.addComponent(cc.Sprite).spriteFrame = this.ballBlue;
S.setPosition(this.getPosforSC3(a, t[y].Dice3));
this.pnlXX3.addChild(S, 2);
if (20 == y) {
var x = this.drawLine(cc.v2(0, this.getPosforSC2(a, t[y].DiceSum).y), this.getPosforSC2(a, t[y].DiceSum), 4, cc.color(255, 255, 255));
this.pnlXXT.addChild(x, 1);
var D = this.drawLine(cc.v2(0, this.getPosforSC3(a, t[y].Dice1).y), this.getPosforSC3(a, t[y].Dice1), 4, cc.color(248, 41, 248));
this.pnlXX1.addChild(D, 1);
var B = this.drawLine(cc.v2(0, this.getPosforSC3(a, t[y].Dice2).y), this.getPosforSC3(a, t[y].Dice2), 4, cc.color(251, 251, 2));
this.pnlXX2.addChild(B, 1);
var E = this.drawLine(cc.v2(0, this.getPosforSC3(a, t[y].Dice3).y), this.getPosforSC3(a, t[y].Dice3), 4, cc.color(236, 2, 5));
this.pnlXX3.addChild(E, 1);
} else {
var I = this.drawLine(this.getPosforSC2(a - 1, t[y + 1].DiceSum), this.getPosforSC2(a, t[y].DiceSum), 4, cc.color(255, 255, 255));
this.pnlXXT.addChild(I, 1);
var X = this.drawLine(this.getPosforSC3(a - 1, t[y + 1].Dice1), this.getPosforSC3(a, t[y].Dice1), 4, cc.color(248, 41, 248));
this.pnlXX1.addChild(X, 1);
var A = this.drawLine(this.getPosforSC3(a - 1, t[y + 1].Dice2), this.getPosforSC3(a, t[y].Dice2), 4, cc.color(251, 251, 2));
this.pnlXX2.addChild(A, 1);
var R = this.drawLine(this.getPosforSC3(a - 1, t[y + 1].Dice3), this.getPosforSC3(a, t[y].Dice3), 4, cc.color(236, 2, 5));
...
var i = 31.5 * t, n = 30.5 * (parseInt(e / 3) - 1) + e % 3 * (30.5 / 3);
return cc.v2(i, n);
};
e.prototype.getPosforSC3 = function(t, e) {
var i = 31.5 * t, n = 30.5 * (e - 1);
return cc.v2(i, n);
};
...
lngui.UIWaitingLayout.showWaiting();
i._instance = this;
c.default.instance.sendSignalR("GetTopAccounts", [ s.TxConst.BetType.BET_GOLD, s.TxConst.GameID.TAI_XIU, 20 ]);
};
...
i > 2 && (c.getChildByName("txtTienThang").color = cc.Color.WHITE);
c.getChildByName("txtTongcuoc").getComponent(cc.Label).string = s.TxConst.formatNumberString(n.RequiredBetValue);
c.getChildByName("txtTienThuong").getComponent(cc.Label).string = s.TxConst.formatNumber(n.Prize);
c.getChildByName("txtTenTaiKhoan").getComponent(cc.Label).string = o;
c.getChildByName("txtTienThang").getComponent(cc.Label).string = s.TxConst.formatNumber(a);
c.getChildByName("line").getComponent(cc.Sprite).spriteFrame = this.spfHuanChuong[3];
