...
Live: [ function(t, e, i) {
"use strict";
cc._RF.push(e, "21bb8vL1sdPMIykb3UaEbMl", "Live");
...
this.webview.url = "https://gc-api.tieusi.online/live?gate=rik&game=taixiu&active=false";
};
a([ r(cc.WebView) ], e.prototype, "webview", void 0);
return a([ s ], e);
}(cc.Component);
i.default = l;
cc._RF.pop();
}, {} ],
"TxLive.AudioDefined": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "b425e/08z5GhaUHMZZ70bag", "TxLive.AudioDefined");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
"TxLive.BatNanCtrl": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "c20701kX4FEt5TBlQAQSw7D", "TxLive.BatNanCtrl");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
"TxLive.Chat.NetworkClient": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "7a0a7Lfg85PaqryJH9U0+FH", "TxLive.Chat.NetworkClient");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var c = t("../TxLive.Chat"), s = t("../TxLive.Const"), r = cc._decorator, l = r.ccclass, h = (r.property, 
function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
cc.systemEvent.off(s.TxLiveConst.CHAT_TAIXIU_SOCKET_EVENT, this.onResponeData, this);
cc.systemEvent.on(s.TxLiveConst.CHAT_TAIXIU_SOCKET_EVENT, this.onResponeData, this);
this.mSignalr = new lngui.GateSignalR();
this.mSignalr.connect(s.TxLiveConst.CHAT_TAIXIU_SOCKET_EVENT, t.url, t.hub, lngui.UserManager.instance.mainUserInfo.cookie, !1);
...
"../TxLive.Chat": "TxLive.Chat",
"../TxLive.Const": "TxLive.Const"
} ],
"TxLive.Chat": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "eb203YiEoFLFrS3xB9i/wHv", "TxLive.Chat");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var c = t("./network/TxLive.Chat.NetworkClient"), s = cc._decorator, r = s.ccclass, l = s.property, h = function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
var a = o, c = cc.instantiate(this.templateMessage), s = i.n, r = n;
c.active = !0;
s = (s.localeCompare(lngui.UserManager.instance.mainUserInfo.NickName), r);
...
"./network/TxLive.Chat.NetworkClient": "TxLive.Chat.NetworkClient"
} ],
"TxLive.Const": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "2741bdmm95C86+2DYyH/K21", "TxLive.Const");
Object.defineProperty(i, "__esModule", {
value: !0
});
i.TxLiveConst = void 0;
var n = function() {
function t() {}
...
"TxLive.HistoryTurn": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "12cc17HQJxJ74aB2GL7OzrT", "TxLive.HistoryTurn");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var c = t("./network/TxLive.NetworkClient"), s = t("./TxLive.Const"), r = cc._decorator, l = r.ccclass, h = r.property, u = function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
e.prototype.onLoad = function() {
i._instance = this;
c.default.instance.sendSignalR("GetSessionResultHistory", [ s.TxLiveConst.diceNode.GameSessionID ]);
...
this.m_GameSessionID >= s.TxLiveConst.GameSessionID ? this.m_GameSessionID = s.TxLiveConst.GameSessionID - 1 : c.default.instance.sendSignalR("GetSessionResultHistory", [ this.m_GameSessionID ]);
};
...
this.m_GameSessionID < s.TxLiveConst.GameSessionID - 15 ? this.m_GameSessionID = s.TxLiveConst.GameSessionID - 15 : c.default.instance.sendSignalR("GetSessionResultHistory", [ this.m_GameSessionID ]);
};
...
this.lbTotalBetTai.string = s.TxLiveConst.formatNumber(t);
this.lbTotalRefundTai.string = s.TxLiveConst.formatNumber(i);
this.lbTotalRefundXiu.string = s.TxLiveConst.formatNumber(n);
this.lbTotalBetXiu.string = s.TxLiveConst.formatNumber(e);
...
if (this.m_coinData[0].LocationWinID == s.TxLiveConst.BetGate.GATE_TAI) {
this.imgEffectTai.node.active = !0;
this.imgEffectTai.node.runAction(cc.rotateBy(.5, 360).repeatForever());
} else if (this.m_coinData[0].LocationWinID == s.TxLiveConst.BetGate.GATE_XIU) {
...
n.getChildByName("txtTienDat").getComponent(cc.Label).string = s.TxLiveConst.formatNumber(i.TotalBetValue);
n.getChildByName("txtTraLai").getComponent(cc.Label).string = s.TxLiveConst.formatNumber(i.RefundValue);
...
"./TxLive.Const": "TxLive.Const",
"./network/TxLive.NetworkClient": "TxLive.NetworkClient"
} ],
"TxLive.History": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "2272aFktf9KKo3tggeM3vBq", "TxLive.History");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var c = t("../TxLive.Const"), s = t("../TxLive.MainGame"), r = cc._decorator, l = r.ccclass, h = r.property, u = function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.content = null;
...
var e = "https://txlive." + lngui.ConfigManager.instance.ConfigInfo.Api + "/api/luckydice/GetHistory?token=" + lngui.UserManager.instance.mainUserInfo.GameToken;
c.TxLiveConst.getUrl(e, function(e, i) {
if (i >= 200 && i < 400) {
...
if (t) for (var e = 0; e < t.length; e++) {
var i = t[e], n = i.CreateTime, o = i.BetSide, a = i.Result;
o = 1 == i.BetSide ? "Xỉu" : "Tài";
var s = i.SessionID, r = i.Bet, l = i.Refund, h = i.Award, u = h - r + l, p = cc.instantiate(this.template);
p.position = new cc.Vec3(0, 0, 0);
p.getChildByName("txtPhien").getComponent(cc.Label).string = "" + s;
if (n.length > 0) {
var m = c.TxLiveConst.formatDateTime2(n);
p.getChildByName("txtThoiGian").getComponent(cc.Label).string = m;
p.getChildByName("txtThoiGian").color = cc.Color.WHITE;
}
if (u > 0) {
p.getChildByName("txtTienThang").getComponent(cc.Label).string = h;
...
p.getChildByName("txtTongCuoc").getComponent(cc.Label).string = c.TxLiveConst.formatNumber(r - l);
p.getChildByName("txtChiTiet").getComponent(cc.Label).string = "Đặt " + o + ". Kết quả " + a + ", Tổng đặt \n" + c.TxLiveConst.formatNumber(r) + " Hoàn trả " + c.TxLiveConst.formatNumber(l) + " Nhận " + c.TxLiveConst.formatNumber(h);
...
"../TxLive.Const": "TxLive.Const",
"../TxLive.MainGame": "TxLive.MainGame"
} ],
"TxLive.ItemHistory": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "e22ecpNkfZPTIP28hcmqVdV", "TxLive.ItemHistory");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var c = t("../TxLive.Const"), s = cc._decorator, r = s.ccclass, l = s.property, h = function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.txtPhien = null;
...
var i = t, n = i.SessionTime, o = i.LocationName, a = (i.Result, i.Data[0].Username), s = i.Data[1].Username, r = i.Data[2].Username, l = i.Data[0].JackpotValue, h = i.Data[1].JackpotValue, u = i.Data[2].JackpotValue;
i.LocationIDWin;
var p = i.GameSessionID, m = i.TotalJackpot;
this.txtPhien.string = "" + p;
this.txtPhien.node.color = cc.Color.YELLOW;
if (n.length > 0) {
c.TxLiveConst.formatDateTime(n);
...
this.txtTienNohu.string = c.TxLiveConst.formatNumberMin(m);
this.txtTienNohu.node.color = cc.Color.YELLOW;
this.txtVinhDanh1.string = c.TxLiveConst.formatUserName(a);
this.txtVinhDanh2.string = c.TxLiveConst.formatUserName(s);
this.txtVinhDanh3.string = c.TxLiveConst.formatUserName(r);
this.txtTienTrung1.string = c.TxLiveConst.formatNumberMin(l);
this.txtTienTrung1.horizontalAlign = 2;
this.txtTienTrung2.string = c.TxLiveConst.formatNumberMin(h);
this.txtTienTrung2.horizontalAlign = 2;
this.txtTienTrung3.string = c.TxLiveConst.formatNumberMin(u);
...
"TxLive.Jackpot": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "648b9e1clZP+7rcJtlU947G", "TxLive.Jackpot");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var i = t[e], n = i.SessionTime, o = i.LocationName, a = (i.Result, i.Data[0].Username), c = i.Data[1].Username, r = i.Data[2].Username, l = i.Data[0].JackpotValue, h = i.Data[1].JackpotValue, u = i.Data[2].JackpotValue;
i.LocationIDWin;
var p = i.GameSessionID, m = i.TotalJackpot, d = cc.instantiate(this.template);
d.active = !0;
d.setPosition(0, 0);
d.getChildByName("txtPhien").getComponent(cc.Label).string = "" + p;
d.getChildByName("txtPhien").color = cc.Color.YELLOW;
if (n.length > 0) {
var g = s.TxLiveConst.formatDateTime(n);
d.getChildByName("txtThoiGian").getComponent(cc.Label).string = g;
d.getChildByName("txtThoiGian").color = cc.Color.WHITE;
}
d.getChildByName("Dice1").getComponent(cc.Sprite).spriteFrame = this.SprDice[i.Dice1 - 1];
d.getChildByName("Dice2").getComponent(cc.Sprite).spriteFrame = this.SprDice[i.Dice1 - 1];
d.getChildByName("Dice3").getComponent(cc.Sprite).spriteFrame = this.SprDice[i.Dice1 - 1];
d.getChildByName("lineJp").getComponent(cc.Sprite).spriteFrame = this.bguser[0];
d.getChildByName("lineJp").active = !(e % 2);
d.getChildByName("txtCuaDat").getComponent(cc.Label).string = o;
d.getChildByName("txtCuaDat").color = cc.Color.WHITE;
d.getChildByName("Btn-Vinhdanh").getComponent(cc.Sprite).spriteFrame = this.bguser[1];
d.getChildByName("Btn-Vinhdanh").on("click", this.touchbtnchitiet, this);
d.getChildByName("Btn-Vinhdanh").name = e.toString();
d.getChildByName("txtTienNohu").getComponent(cc.Label).string = s.TxLiveConst.formatNumberMin(m);
d.getChildByName("txtTienNohu").color = cc.Color.YELLOW;
d.getChildByName("txtVinhDanh1").getComponent(cc.Label).string = s.TxLiveConst.formatUserName(a);
d.getChildByName("txtVinhDanh2").getComponent(cc.Label).string = s.TxLiveConst.formatUserName(c);
d.getChildByName("txtVinhDanh3").getComponent(cc.Label).string = s.TxLiveConst.formatUserName(r);
d.getChildByName("txtTienTrung1").getComponent(cc.Label).string = s.TxLiveConst.formatNumberMin(l);
d.getChildByName("txtTienTrung1").getComponent(cc.Label).horizontalAlign = 2;
d.getChildByName("txtTienTrung2").getComponent(cc.Label).string = s.TxLiveConst.formatNumberMin(h);
d.getChildByName("txtTienTrung2").getComponent(cc.Label).horizontalAlign = 2;
d.getChildByName("txtTienTrung3").getComponent(cc.Label).string = s.TxLiveConst.formatNumberMin(u);
d.getChildByName("txtTienTrung3").getComponent(cc.Label).horizontalAlign = 2;
d.color = e % 2 == 0 ? cc.color(38, 4, 0) : cc.color(255, 255, 255);
...
r.getChildByName("txtTienThuong").getComponent(cc.Label).string = s.TxLiveConst.formatNumber(c);
...
"TxLive.MainGame": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "a80edAVR+dIdbnNjvlRU7Ij", "TxLive.MainGame");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var c = t("./TxLive.BatNanCtrl"), s = t("./network/TxLive.NetworkClient"), r = t("./TxLive.Const"), l = cc._decorator, h = l.ccclass, u = l.property, p = function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
e.m_nGameStatus = 0;
...
this.nodechokq.active = !1;
this.nodeLive.active = !0;
this.btnLive.node.getComponent(cc.Sprite).spriteFrame = this.hidevideo;
this.initTaiXiu();
};
...
for (var t = 0; t < r.TxLiveConst.MAX_KEY_VALUE; t++) {
...
if (this.nodeLive.active) {
this.nodeLive.active = !1;
this.btnLive.node.getComponent(cc.Sprite).spriteFrame = this.hidevideo;
} else {
this.nodeLive.active = !0;
this.btnLive.node.getComponent(cc.Sprite).spriteFrame = this.showvideo;
}
};
...
if (this.m_llBetValue > r.TxLiveConst.MAX_BET_TAI_XIU) {
this.m_llBetValue = r.TxLiveConst.MAX_BET_TAI_XIU;
this.showMessage("Chỉ đặt cửa trong khoảng 10 đến " + r.TxLiveConst.formatNumber(r.TxLiveConst.MAX_BET_TAI_XIU));
}
this.m_nBetGate == r.TxLiveConst.BetGate.GATE_XIU ? this.ebInputBetXiu.string = r.TxLiveConst.formatNumber(this.m_llBetValue) : this.ebInputBetTai.string = r.TxLiveConst.formatNumber(this.m_llBetValue);
};
...
this.keyPadValue = "";
this.m_llBetValue = 0;
this.m_nBetGate = r.TxLiveConst.BetGate.NONE;
...
this.keyPadValue = r.TxLiveConst.formatNumber(this.m_llBetValue);
this.m_nBetGate == r.TxLiveConst.BetGate.GATE_XIU ? this.ebInputBetXiu.string = r.TxLiveConst.formatNumber(this.m_llBetValue) : this.ebInputBetTai.string = r.TxLiveConst.formatNumber(this.m_llBetValue);
};
...
e = t[0].Award;
i = t[0].Refund;
if (this.m_nGameStatus == r.TxLiveConst.GameStatus.RESULT) {
this.setBalance(nBetType, n);
this.showPrizeValue(e, i);
}
}
};
...
var i = t;
if (t > 0) {
var n = "+" + r.TxLiveConst.formatNumber(parseInt(i));
...
n = "+" + r.TxLiveConst.formatNumber(parseInt(e));
this.m_lblMoneyWin.node.color = cc.Color.YELLOW;
this.m_lblMoneyWin.string = n;
this.m_lblMoneyWin.node.active = !0;
this.m_nLocationIDWin == r.TxLiveConst.BetGate.GATE_TAI ? this.m_lblMoneyWin.node.setPosition(565, 207) : this.m_lblMoneyWin.node.setPosition(181, 207);
this.m_lblMoneyWin.node.runAction(cc.moveBy(3, cc.v2(0, 40)));
this.node.runAction(cc.sequence(cc.delayTime(3), cc.callFunc(function() {
this.m_lblMoneyWin.node.active = !1;
}, this)));
} else {
n = "-" + r.TxLiveConst.formatNumber(parseInt(t));
...
lngui.AudioManager.instance.playSfx(this.Click, 1);
this.m_lblMessage.string = "";
if (0 != this.m_llBetValue) if (this.m_llBetValue < r.TxLiveConst.MIN_BET && 0 != this.m_llBetValue) this.showMessage("Đặt cửa không hợp lệ."); else if (this.m_llBetValue > r.TxLiveConst.MAX_BET_TAI_XIU) this.showMessage("Mỗi lần đặt cửa tối đa không được vượt quá " + r.TxLiveConst.convertToK(r.TxLiveConst.MAX_BET_TAI_XIU) + " Gold"); else {
if (this.m_nBetType == r.TxLiveConst.BetType.BET_GOLD) if (this.m_nBetGate == r.TxLiveConst.BetGate.GATE_TAI) {
if (this.m_llBetValue + this.m_totalBetTai > r.TxLiveConst.MAX_BET_PER_SESSION) {
r.TxLiveConst.convertToK;
this.showMessage("Đặt cửa mỗi phiên không vượt quá  " + r.TxLiveConst.convertToK(r.TxLiveConst.MAX_BET_PER_SESSION) + " Gold. Vui lòng đợi lượt sau");
return;
}
} else if (this.m_nBetGate == r.TxLiveConst.BetGate.GATE_XIU && this.m_llBetValue + this.m_totalBetXiu > r.TxLiveConst.MAX_BET_PER_SESSION) {
this.showMessage("Đặt cửa mỗi phiên không vượt quá  " + r.TxLiveConst.convertToK(r.TxLiveConst.MAX_BET_PER_SESSION) + " Gold. Vui lòng đợi lượt sau");
return;
}
if (this.m_nGameStatus != r.TxLiveConst.GameStatus.RESULT && this.m_nGameStatus != r.TxLiveConst.GameStatus.PREPARE_NEW_SESSION) {
this.cuoctai.node.active = !0;
this.cuocxiu.node.active = !0;
this.SetBet();
...
if (this.m_nGameStatus == r.TxLiveConst.GameStatus.BETTING) {
s.default.instance.sendSignalR("Bet", [ this.m_llBetValue, this.m_nBetGate, 1 ]);
this.keyPadValue = "";
this.m_llBetValue = 0;
this.m_nBetGate == r.TxLiveConst.BetGate.GATE_XIU ? this.ebInputBetXiu.string = "0" : this.ebInputBetTai.string = "0";
} else this.showMessage("Hết thời gian đặt cửa");
};
e.prototype.betOfAccount = function(t) {
if (t.length) {
var e = t[0], i = t[1];
i >= 0 && lngui.EventDispatch.instance.emit(lngui.EVENT_GAMECORE.UPDATE_TOTAL_GOLD, i);
var n = e.BetSide, o = e.BetValue;
this.setBettedVal(n, o);
}
};
e.prototype.setBettedVal = function(t, e) {
if (t == r.TxLiveConst.BetGate.GATE_TAI) {
this.ebInputBetXiu.enabled = !1;
this.m_lblBetedValueTai.string = r.TxLiveConst.formatNumber(e);
} else if (t == r.TxLiveConst.BetGate.GATE_XIU) {
this.ebInputBetTai.enabled = !1;
this.m_lblBetedValueXiu.string = r.TxLiveConst.formatNumber(e);
}
};
e.prototype.betByaccount = function(t) {
if (t.BetSide == r.TxLiveConst.BetGate.GATE_TAI) {
this.ebInputBetXiu.enabled = !1;
this.m_lblBetedValueTai.string = r.TxLiveConst.formatNumber(t.BetValue);
} else if (t.BetSide == r.TxLiveConst.BetGate.GATE_XIU) {
this.ebInputBetTai.enabled = !1;
this.m_lblBetedValueXiu.string = r.TxLiveConst.formatNumber(t.BetValue);
}
};
...
if (this.m_llBetValue > r.TxLiveConst.MAX_BET_TAI_XIU) {
this.m_llBetValue = r.TxLiveConst.MAX_BET_TAI_XIU;
this.showMessage("Chỉ đặt cửa trong khoảng 10 đến " + r.TxLiveConst.formatNumber(r.TxLiveConst.MAX_BET_TAI_XIU) + " Gold");
}
this.m_nBetGate == r.TxLiveConst.BetGate.GATE_XIU ? this.ebInputBetXiu.string = r.TxLiveConst.formatNumber(this.m_llBetValue) : this.ebInputBetTai.string = r.TxLiveConst.formatNumber(this.m_llBetValue);
...
if (null != i) {
e = this.m_nBetGate == r.TxLiveConst.BetGate.GATE_TAI ? this.btnChonTai.node.getPosition() : this.btnChonXiu.node.getPosition();
i.position = t;
...
var e = t, i = e.TotalXiu, n = e.TotalBetXiu, o = e.TotalTai, a = e.TotalBetTai;
this.m_lblMoneyTai.string = r.TxLiveConst.convertToMoney(a);
this.m_totalBetTai = a;
this.m_lblMoneyXiu.string = r.TxLiveConst.convertToMoney(n);
this.m_totalBetXiu = n;
this.m_lblUsersTai.string = "(" + r.TxLiveConst.formatNumber(o) + ")";
this.m_lblUsersXiu.string = "(" + r.TxLiveConst.formatNumber(i) + ")";
var c = cc.sequence(cc.scaleTo(.1, 1.1, 1.1), cc.scaleTo(.1, 1, 1));
a !== this._totalBetTai && this.m_lblMoneyTai.node.runAction(c.clone());
n !== this._totalBetXiu && this.m_lblMoneyXiu.node.runAction(c.clone());
o !== this._totalAccountTai && this.m_lblUsersTai.node.runAction(c.clone());
i !== this._totalAccountXiu && this.m_lblUsersXiu.node.runAction(c.clone());
this._totalBetXiu = n;
this._totalBetTai = a;
this._totalAccountXiu = i;
this._totalAccountTai = o;
};
...
if (null != t) {
this.resetBat();
r.TxLiveConst.GameSessionID = t.SessionID;
...
if (this.m_nGameStatus == r.TxLiveConst.GameStatus.BETTING) {
this.m_nRemainWaiting = t.Ellapsed;
...
this.m_nGameStatus == r.TxLiveConst.GameStatus.END_BETTING ? this.nodechokq.active = !0 : this.nodechokq.active = !1;
this.startTimer();
}
};
...
case r.TxLiveConst.GameStatus.END_BETTING:
case r.TxLiveConst.GameStatus.PREPARE_NEW_SESSION:
case r.TxLiveConst.GameStatus.RESULT:
this.btnChonTai.interactable = !0;
this.ebInputBetTai.enabled = !0;
this.btnChonXiu.interactable = !0;
this.ebInputBetXiu.enabled = !0;
...
case r.TxLiveConst.GameStatus.BETTING:
this.showDices(!1);
this.imgBgTimer2.active = !1;
this.m_imgEffectTai.node.stopAllActions();
this.m_imgEffectXiu.node.stopAllActions();
...
this.imgBgTimer2.active || (this.m_lblTimer.node.active = !0);
...
e.prototype.startCountDownWaiting = function() {
this.imgBgTimer2.active && (this.m_lblTimer.node.active = !1);
if (this.m_nGameStatus == r.TxLiveConst.GameStatus.RESULT) if (this.m_isNan && !this.m_isTouchNan) {
if (1 == this.m_nRemainWaiting) {
this.GetAccountResult();
this.resetBat();
}
} else 5 == this.m_nRemainWaiting && this.GetAccountResult(); else if (this.m_nGameStatus == r.TxLiveConst.GameStatus.BETTING) {
this.m_nRemainWaiting > 22 && this.showMessage("Bắt Đầu Ván Mới.");
6 == this.m_nRemainWaiting && this.showMessage("Trả Tiền Cân Cửa.");
if (this.m_nRemainWaiting <= 5) {
...
var e = t.Result.Dice1 + t.Result.Dice2 + t.Result.Dice3;
if (!(this.m_imgDice1.node.active || this.m_imgDice2.node.active || this.m_imgDice3.node.active)) {
this.m_nLocationIDWin = e > 10 ? 0 : 1;
this.m_imgDice1.getComponent(cc.Sprite).spriteFrame = this.imgDices1[t.Result.Dice1 - 1];
this.m_imgDice1.node.active = !1;
this.m_imgDice2.getComponent(cc.Sprite).spriteFrame = this.imgDices2[t.Result.Dice2 - 1];
this.m_imgDice2.node.active = !1;
this.m_imgDice3.getComponent(cc.Sprite).spriteFrame = this.imgDices3[t.Result.Dice3 - 1];
this.m_imgDice3.node.active = !1;
this.m_imgResult.getChildByName("txtResult").getComponent(cc.Label).string = "" + (t.Result.Dice1 + t.Result.Dice2 + t.Result.Dice3);
this.m_imgResult.active = !1;
this.m_nGameStatus == r.TxLiveConst.GameStatus.RESULT && -1 != t.Result.Dice1 && this.startAnimation();
}
};
e.prototype.startAnimation = function() {
var t = this;
console.log("Đã show kết quả");
this.m_lblTimer.node.active = !1;
...
this.m_imgResult.active = !1;
if (this.m_nLocationIDWin == r.TxLiveConst.BetGate.GATE_TAI) {
lngui.AudioManager.instance.playSfx(this.KetQua, 1);
this.m_imgEffectTai.node.active = !0;
} else if (this.m_nLocationIDWin == r.TxLiveConst.BetGate.GATE_XIU) {
lngui.AudioManager.instance.playSfx(this.KetQua, 1);
this.m_imgEffectXiu.node.active = !0;
}
null != this._callback && this._callback(r.TxLiveConst.RETURN_RESULT, this.m_nLocationIDWin);
} else {
...
if (t.length) {
r.TxLiveConst.dataHistoryGame = t;
var e = t, i = e.length;
if (0 != i) {
i > 14 && (i = 14);
this.m_lblMessage.string = "";
...
var l = e[s].BetSide, h = new cc.Node(), u = h.addComponent(cc.Sprite);
l == r.TxLiveConst.BetGate.GATE_TAI ? u.spriteFrame = 0 == s ? n : o : u.spriteFrame = 0 == s ? a : c;
this.m_historyPanel.addChild(h);
h.y = this.firstPosHis.y;
h.x = this.firstPosHis.x - s * (this.diceWith + 10);
h.active = !0;
h.width = 31;
h.height = 31;
h.name = e[s].SessionId.toString();
h.on(cc.Node.EventType.TOUCH_END, this.touchShowHistoryTurn, this, !0);
0 == s && h.runAction(cc.sequence(cc.moveBy(.2, 0, 10), cc.moveBy(.2, 0, -10)).repeatForever());
}
}
}
};
e.prototype.touchShowHistoryTurn = function(t) {
r.TxLiveConst.diceNode.GameSessionID = parseInt(t.target.name);
lngui.UIPopupManager.instance.showPopupFromPrefab(this.HisTurn);
};
e.prototype.touchTai = function() {
lngui.AudioManager.instance.playSfx(this.Click, 1);
if (this.m_nGameStatus != r.TxLiveConst.GameStatus.RESULT && this.m_nGameStatus != r.TxLiveConst.GameStatus.PREPARE_NEW_SESSION) if (this.m_nBetGate != r.TxLiveConst.BetGate.GATE_XIU || "0" == this.m_lblBetedValueXiu.string) {
this.m_nBetGate = r.TxLiveConst.BetGate.GATE_TAI;
this.m_llBetValue = 0;
...
lngui.AudioManager.instance.playSfx(this.Click, 1);
if (this.m_nGameStatus != r.TxLiveConst.GameStatus.RESULT && this.m_nGameStatus != r.TxLiveConst.GameStatus.PREPARE_NEW_SESSION) if (this.m_nBetGate != r.TxLiveConst.BetGate.GATE_TAI || "0" == this.m_lblBetedValueTai.string) {
this.m_nBetGate = r.TxLiveConst.BetGate.GATE_XIU;
this.m_llBetValue = 0;
...
a([ u(sp.Skeleton) ], e.prototype, "m_imgEffectTai", void 0);
a([ u(sp.Skeleton) ], e.prototype, "m_imgEffectXiu", void 0);
...
a([ u(cc.SpriteFrame) ], e.prototype, "showvideo", void 0);
a([ u(cc.SpriteFrame) ], e.prototype, "hidevideo", void 0);
...
a([ u(cc.Node) ], e.prototype, "bordermsg", void 0);
a([ u(cc.Node) ], e.prototype, "nodeLive", void 0);
a([ u(cc.Node) ], e.prototype, "nodeViewLive", void 0);
a([ u(cc.Node) ], e.prototype, "nodechokq", void 0);
...
a([ u(sp.Skeleton) ], e.prototype, "SkeConRong", void 0);
...
a([ u(cc.Sprite) ], e.prototype, "cuocxiu", void 0);
a([ u(cc.Sprite) ], e.prototype, "cuoctai", void 0);
...
a([ u(cc.Button) ], e.prototype, "btnLive", void 0);
a([ u(cc.Prefab) ], e.prototype, "HisTurn", void 0);
a([ u(cc.AudioClip) ], e.prototype, "coin_drop", void 0);
a([ u(cc.AudioClip) ], e.prototype, "XucXac", void 0);
a([ u(cc.AudioClip) ], e.prototype, "Click", void 0);
a([ u(cc.AudioClip) ], e.prototype, "KetQua", void 0);
return i = a([ h ], e);
}(cc.Component);
i.default = p;
cc._RF.pop();
}, {
"./TxLive.BatNanCtrl": "TxLive.BatNanCtrl",
"./TxLive.Const": "TxLive.Const",
"./network/TxLive.NetworkClient": "TxLive.NetworkClient"
} ],
"TxLive.NetworkClient": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "4d882v2pQ1GuZExKGwHWxvQ", "TxLive.NetworkClient");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
var c = t("../popup/TxLive.VinhDanh"), s = t("../TxLive.Const"), r = t("../TxLive.HistoryTurn"), l = t("../TxLive.MainGame"), h = t("../popup/TxLive.Jackpot"), u = cc._decorator, p = u.ccclass, m = (u.property, 
function(t) {
o(e, t);
function e() {
var e = null !== t && t.apply(this, arguments) || this;
...
console.log("Connect");
var t = {
url: "https://txlive-rik." + lngui.ConfigManager.instance.ConfigInfo.Api + "/signalr/negotiate",
hub: "luckydiceHub",
ip: "http://18.138.207.162:9001/signalr/negotiate",
gate: "rik.vip"
};
cc.systemEvent.off(s.TxLiveConst.ON_TAIXIU_SOCKET, this.onResponeData, this);
cc.systemEvent.on(s.TxLiveConst.ON_TAIXIU_SOCKET, this.onResponeData, this);
this.mSignalr = new lngui.GateSignalR();
this.mSignalr.connect(s.TxLiveConst.ON_TAIXIU_SOCKET, t.url, t.hub, lngui.UserManager.instance.mainUserInfo.cookie, !1);
lngui.GateWebSocketManager.pushSignalR(this.mSignalr);
};
e.prototype.onEnable = function() {
...
switch (n.M) {
case "sessionInfo":
l.default.instance.currentRoomsInfo(o);
l.default.instance.currentSession(o);
l.default.instance.currentResult(o);
break;

case "gameHistory":
l.default.instance.gameHistory(o);
break;

case "eventRank":
l.default.instance.setEventRank(o);
break;

case "winResult":
l.default.instance.resultOfAccount(o);
break;

case "betSuccess":
l.default.instance.betOfAccount(n.A);
break;

case "betOfAccount":
l.default.instance.betByaccount(o);
break;

case "sessionHistory":
r.default.instance.showHistoryTurnTaiXiu(o);
break;
...
"../TxLive.Const": "TxLive.Const",
"../TxLive.HistoryTurn": "TxLive.HistoryTurn",
"../TxLive.MainGame": "TxLive.MainGame",
"../popup/TxLive.Jackpot": "TxLive.Jackpot",
"../popup/TxLive.VinhDanh": "TxLive.VinhDanh"
} ],
"TxLive.SoiCau": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "ae3ecyBerhBVYJzhWA0RN9a", "TxLive.SoiCau");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
this.initData(c.TxLiveConst.dataHistoryGame);
};
...
var d = new cc.Node(), g = d.addComponent(cc.Sprite), v = null;
if (t[m].DiceSum > 10) {
v = 0 == m ? this.nutdenActive : this.nutdenIcon;
u++;
} else {
v = 0 == m ? this.nuttrangActive : this.nuttrangIcon;
p++;
}
v && (g.spriteFrame = v);
d.setPosition(this.getPosforSCmoi(h, l));
...
for (var f = t.length > 14 ? 14 : t.length, T = (o = 0, f > 14 ? 14 : f); T >= 0; T--) {
var _ = new cc.Node(), y = _.addComponent(cc.Sprite);
t[T].DiceSum > 10 ? y.spriteFrame = this.ballBlack : y.spriteFrame = this.ballWhite;
_.setPosition(this.getPosforSC2(o, t[T].DiceSum));
this.pnlXXT.addChild(_, 2);
var C = new cc.Node();
C.addComponent(cc.Sprite).spriteFrame = this.ballYellow;
C.setPosition(this.getPosforSC3(o, t[T].Dice1));
this.pnlXX1.addChild(C, 2);
var b = new cc.Node();
b.addComponent(cc.Sprite).spriteFrame = this.ballRed;
b.setPosition(this.getPosforSC3(o, t[T].Dice2));
this.pnlXX2.addChild(b, 2);
var S = new cc.Node();
S.addComponent(cc.Sprite).spriteFrame = this.ballBlue;
S.setPosition(this.getPosforSC3(o, t[T].Dice3));
this.pnlXX3.addChild(S, 2);
if (14 == T) {
var N = this.drawLine(cc.v2(0, this.getPosforSC2(o, t[T].DiceSum).y), this.getPosforSC2(o, t[T].DiceSum), 4, cc.color(255, 239, 135));
this.pnlXXT.addChild(N, 1);
var L = this.drawLine(cc.v2(0, this.getPosforSC3(o, t[T].Dice1).y), this.getPosforSC3(o, t[T].Dice1), 2, cc.color(250, 255, 2));
this.pnlXX1.addChild(L, 1);
var x = this.drawLine(cc.v2(0, this.getPosforSC3(o, t[T].Dice2).y), this.getPosforSC3(o, t[T].Dice2), 2, cc.color(255, 93, 117));
this.pnlXX2.addChild(x, 1);
var B = this.drawLine(cc.v2(0, this.getPosforSC3(o, t[T].Dice3).y), this.getPosforSC3(o, t[T].Dice3), 2, cc.color(97, 239, 251));
this.pnlXX3.addChild(B, 1);
} else {
var E = this.drawLine(this.getPosforSC2(o - 1, t[T + 1].DiceSum), this.getPosforSC2(o, t[T].DiceSum), 4, cc.color(255, 239, 135));
this.pnlXXT.addChild(E, 1);
var D = this.drawLine(this.getPosforSC3(o - 1, t[T + 1].Dice1), this.getPosforSC3(o, t[T].Dice1), 2, cc.color(250, 255, 2));
this.pnlXX1.addChild(D, 1);
var I = this.drawLine(this.getPosforSC3(o - 1, t[T + 1].Dice2), this.getPosforSC3(o, t[T].Dice2), 2, cc.color(255, 93, 117));
this.pnlXX2.addChild(I, 1);
var X = this.drawLine(this.getPosforSC3(o - 1, t[T + 1].Dice3), this.getPosforSC3(o, t[T].Dice3), 2, cc.color(97, 239, 251));
this.pnlXX3.addChild(X, 1);
}
o++;
}
};
...
"TxLive.VinhDanh": [ function(t, e, i) {
"use strict";
cc._RF.push(e, "afdf2U2mzpBHbTK0LAuFtZj", "TxLive.VinhDanh");
var n, o = this && this.__extends || (n = function(t, e) {
return (n = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
lngui.UIWaitingLayout.showWaiting();
i._instance = this;
c.default.instance.sendSignalR("GetTopAccounts", [ s.TxLiveConst.BetType.BET_GOLD, s.TxLiveConst.GameID.TAI_XIU, 20 ]);
};
...
1 == n.IsSatisfy ? c.getChildByName("tick").getComponent(cc.Sprite).spriteFrame = this.spfHuanChuong[4] : c.getChildByName("tick").getComponent(cc.Sprite).spriteFrame = this.spfHuanChuong[5];
c.getChildByName("sprGift").getComponent(cc.Sprite).spriteFrame = i < 5 ? this.spfGift[i] : 5 == i || 6 == i ? this.spfGift[5] : 7 == i || 8 == i ? this.spfGift[6] : 9 == i || 11 == i ? this.spfGift[7] : 12 == i || 14 == i ? this.spfGift[8] : this.spfGift[9];
c.getChildByName("txtTongcuoc").getComponent(cc.Label).string = s.TxLiveConst.formatNumberString(n.RequiredBetValue);
c.getChildByName("txtTienThuong").getComponent(cc.Label).string = s.TxLiveConst.formatNumber(n.Prize);
c.getChildByName("txtTenTaiKhoan").getComponent(cc.Label).string = o;
c.getChildByName("txtTienThang").getComponent(cc.Label).string = s.TxLiveConst.formatNumber(a);
...
a([ h([ cc.SpriteFrame ]) ], e.prototype, "spfGift", void 0);
return i = a([ l ], e);
}(cc.Component);
i.default = u;
cc._RF.pop();
...
"TxLive.lbCountDown": [ function(t, e) {
"use strict";
cc._RF.push(e, "472c3tbrh1G0LHOSrxGqCtZ", "TxLive.lbCountDown");
cc.Class({
...
}, {}, [ "Live", "TxLive.BatNanCtrl", "TxLive.Chat", "TxLive.Const", "TxLive.HistoryTurn", "TxLive.MainGame", "TxLive.SoiCau", "TxLive.AudioDefined", "TxLive.lbCountDown", "TxLive.Chat.NetworkClient", "TxLive.NetworkClient", "TxLive.History", "TxLive.ItemHistory", "TxLive.Jackpot", "TxLive.VinhDanh" ]);