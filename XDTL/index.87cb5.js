...
this.chatShortcuts = [ "Chẵn là không lằng nhằng", "Lẻ là không có lẻ tẻ", "Đen như mực", "Có sữa cho con rồi", "Mực này nuốt được", "Thời tới khó cản", "Má, lại bẻ cầu", "Hũ nổ đi em ơi", "Xin nhẹ quả lẻ", "Cầu như lol vậy", "DM mấy tay không ăn được" ];
},
...
this.nodeProgressTimer.active = !1;
...
this.minYs = [ 45, -180, -180, 45, -180, -180, 0 ];
this.maxYs = [ 63, -163, -163, 63, -163, -163, 0 ];
this.rootDealerPos = cc.v2(0, 136);
this.chipIndex = 1;
this.betVals = [ 500, 1e3, 5e3, 1e4, 5e4, 1e5, 5e5, 1e6, 5e6, 1e7 ];
...
this.animationBat.setAnimation(0, "Idle", !1);
...
this.animationBat.clearTracks();
this.animationBat.setToSetupPose();
this.animationBat.setAnimation(0, "Xoc Dia", !1);
this.resultSession = null;
}
}
this.currentState = n;
...
var e = this, i = this;
setTimeout(function() {
e.nodeFxResult.active = !0;
e.nodeResult.active = !0;
}, 1e3);
...
console.log(i.resultSession);
setTimeout(function() {
1 == cc.XDTL_Controller.getInstance().getRoomId() && null != i.resultSession && i.currentState == cc.XDTL_State.OPEN_PLATE && cc.XDTL_Controller.getInstance().runAnimationSpin(!0, i.resultSession);
}, 2e3);
setTimeout(function() {
if (null != i.resultSession && i.resultSession.IsHu > 0 && 1 == cc.XDTL_Controller.getInstance().getRoomId() && i.currentState == cc.XDTL_State.OPEN_PLATE) {
cc.XDTL_Controller.getInstance().showEffectNohu(i.resultSession);
i.playFxHu(i.resultSession.IsHu);
}
}, 4e3);
},
playPayFx: function(t, e) {
this.resultSession = e;
var i = parseInt(e.BigGate), n = parseInt(e.SmallGate);
switch (i) {
case cc.XDTL_Gate.EVEN:
...
this.animationBat.clearTracks();
this.animationBat.setToSetupPose();
this.animationBat.setAnimation(0, "3 trang", !1);
...
this.animationBat.clearTracks();
this.animationBat.setToSetupPose();
this.animationBat.setAnimation(0, "3 vang", !1);
this.nodeLe1.active = !0;
...
this.animationBat.clearTracks();
this.animationBat.setToSetupPose();
this.animationBat.setAnimation(0, "4 trang", !1);
...
this.animationBat.clearTracks();
this.animationBat.setToSetupPose();
this.animationBat.setAnimation(0, "4 vang", !1);
this.nodeChan1.active = !0;
...
this.animationBat.clearTracks();
this.animationBat.setToSetupPose();
this.animationBat.setAnimation(0, "2 vang", !1);
this.nodeChan1.active = !0;
...
playWinLoseChip: function(t) {
var e = cc.XDTL_Controller.getInstance().getGateChips(), i = [ parseInt(t.BigGate), parseInt(t.SmallGate) ], n = [];
e.map(function(t, e) {
i.includes(e) || n.push(e);
}, this);
this.fxMoveChip(n, cc.XDTL_FX.LOSE);
setTimeout(function() {
this.fxMoveChip(i, cc.XDTL_FX.DEALER_PAY);
}.bind(this), 1e3);
setTimeout(function() {
this.fxMoveChip(i, cc.XDTL_FX.PAY);
}.bind(this), 2e3);
},
