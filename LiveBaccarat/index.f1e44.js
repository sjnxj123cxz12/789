...
LiveBaccarat: [ function(t, e, n) {
"use strict";
cc._RF.push(e, "c2c6e8NiOJBV5aun/v46kYX", "LiveBaccarat");
...
var e = "https://api.dragonf1.xyz/Account3rd/Get3rdAccountInfo?token=" + fzgui.UserManager.instance.mainUserInfo.GameToken + "&ProviderId=9";
...
fzgui.UIWaitingLayout.showWaiting();
if ("You88" == this.Quy1.string) {
var n = e + "?token=" + fzgui.UserManager.instance.mainUserInfo.GameToken + "&ProviderId=9&amount=" + this.amountnhan + "&type=";
...
n = e + "?token=" + fzgui.UserManager.instance.mainUserInfo.GameToken + "&ProviderId=9&amount=" + this.edbAmount.string + "&type=";
...
WebViewBaccarat: [ function(t, e, n) {
"use strict";
cc._RF.push(e, "a599bYes2hFQrd+nHxYcHXX", "WebViewBaccarat");
var o, i = this && this.__extends || (o = function(t, e) {
return (o = Object.setPrototypeOf || {
__proto__: []
} instanceof Array && function(t, e) {
...
e.prototype.start = function() {
var t = this, e = "https://api.dragonf1.xyz/Account3rd/LaunchGames?token=" + fzgui.UserManager.instance.mainUserInfo.GameToken + "&ProviderId=9";
this.getUrl(e, function(e, n) {
n >= 200 && n < 400 ? t.webview.url = e : fzgui.UIPopupManager.instance.showPopup(e);
});
};
e.prototype.getUrl = function(t, e) {
var n = t, o = cc.loader.getXMLHttpRequest();
