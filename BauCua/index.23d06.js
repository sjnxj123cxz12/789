...
"use strict";
cc._RF.push(e, "c16ceTs+DhNCqhiRqLoLgRw", "AudioPoolBauCua");
(function() {
...
"use strict";
cc._RF.push(e, "241a9HShmhOfb6/08guUbhp", "BauCuaAnim");
cc.BauCuaAnim = {
SHAKING: "shake",
OPEN_PLATE: "open2",
CLOSE_PLATE: "close2"
...
"use strict";
cc._RF.push(e, "082f2xR+aVDOr5sqwkuxcbP", "BauCuaAssetsView");
(function() {
...
"use strict";
cc._RF.push(e, "62917515RdMkrO17bczBxoR", "BauCuaBetSide");
cc.BauCuaBetSide = {
Gourd: 1,
Crab: 2,
Fish: 3,
...
"use strict";
cc._RF.push(e, "3b20dhrMmBLl5efV78FDjYV", "BauCuaBetView");
(function() {
...
var i = t.getChildByName("win");
i.active = e;
cc.tween(i).repeatForever(cc.tween().to(.5, {
opacity: 0
}).to(.5, {
opacity: 255
})).start();
...
var e = cc.moveTo(.3, cc.v2(t.x, -30));
t.runAction(e);
},
...
var e = cc.moveTo(.3, cc.v2(t.x, -50));
t.runAction(e);
},
...
var i = [ 1e6, 5e5, 1e5, 1e4, 5e3, 1e3 ], o = this.getTotalMoneyBetSide(t, e), n = [];
for (var s in i) {
...
t = parseInt(t);
this.getLabelTotalBetBySide(t).string = cc.Tool.getInstance().formatNumberK(e);
},
updateBetOfAccount: function(t) {
var e = this;
t.map(function(t) {
var i = parseInt(t.BetSide);
e.getLabelTotalBetBySide(i).string = cc.Tool.getInstance().formatNumberK(t.BetValue);
});
},
...
t.string = 0 === e ? "" : cc.Tool.getInstance().formatNumberK(e);
},
...
"use strict";
cc._RF.push(e, "4e4956E3UBCWImC8OHnFXwZ", "BauCuaButtonBet");
(function() {
...
"use strict";
cc._RF.push(e, "b54c7q1TaFOCa8yTDEVbRIN", "BauCuaChipView");
(function() {
...
"use strict";
cc._RF.push(e, "748ccLO9f1JGrhLJDcEZ530", "BauCuaChipsView");
(function() {
cc.BauCuaChipsView = cc.Class({
extends: cc.Component,
properties: {
...
onLoad: function() {
cc.BauCuaController.getInstance().setChipsView(this);
this.initParamChips();
},
initParamChips: function() {
this.chipsBetPPair = [];
...
if (i === cc.BacaratChipOf.USERS) {
n = this.posGroupUsers.position;
var s = cc.Bacarat2Controller.getInstance().positionPlayerUI().indexOf(o);
-1 !== s && (n = this.lstPosPlayer[s].position);
}
var a = this.randomPosChip(t, e), c = cc.Bacarat2Controller.getInstance().createChip(cc.BacaratMapChipSpriteFrame[t]);
c.parent = this.layoutChip;
c.position = n;
var r = cc.moveTo(.3, a);
cc.game.isPaused() ? c.position = a : c.runAction(r);
...
switch (e) {
case cc.BacaratBetSite.PLAYER_PAIR:
this.chipsBetPPair.push([ c, t, u ]);
break;

case cc.BacaratBetSite.PLAYER:
this.chipsBetPlayer.push([ c, t, u ]);
break;

case cc.BacaratBetSite.TIE:
this.chipsBetTie.push([ c, t, u ]);
break;

case cc.BacaratBetSite.BANKER:
this.chipsBetBanker.push([ c, t, u ]);
break;

case cc.BacaratBetSite.BANKER_PAIR:
this.chipsBetPBanker.push([ c, t, u ]);
}
} catch (t) {}
},
updateChipForBetSession: function(t) {
...
0 !== t.length && t.map(function(t) {
0 !== t.length && t.map(function(t) {
var i = parseInt(t.BetSide), o = parseInt(t.BetValue), n = cc.Bacarat2Controller.getInstance().createChip(cc.BacaratMapChipSpriteFrame[o]), s = e.randomPosChip(o, i);
n.parent = e.layoutChip;
n.position = s;
var a = e.posGroupUsers.position, c = cc.Bacarat2Controller.getInstance().positionPlayerUI().indexOf(t.AccountID);
-1 !== c && (a = e.lstPosPlayer[c].position);
switch (i) {
case cc.BacaratBetSite.PLAYER_PAIR:
e.chipsBetPPair.push([ n, o, a ]);
break;

case cc.BacaratBetSite.PLAYER:
e.chipsBetPlayer.push([ n, o, a ]);
break;

case cc.BacaratBetSite.TIE:
e.chipsBetTie.push([ n, o, a ]);
break;

case cc.BacaratBetSite.BANKER:
e.chipsBetBanker.push([ n, o, a ]);
break;

case cc.BacaratBetSite.BANKER_PAIR:
e.chipsBetPBanker.push([ n, o, a ]);
}
}, e);
}, this);
},
...
try {
o = .1 * (n = n > 5 ? 5 : n);
var s = cc.Bacarat2Controller.getInstance().createChip(cc.BacaratMapChipSpriteFrame[i[1]]);
s.parent = e.layoutChip;
s.position = e.posDealer.position;
var a = e.randomPosChip(i[1], t);
if (cc.game.isPaused()) s.position = a; else {
...
cc.Bacarat2Controller.getInstance().setChipWin(i[0], i[1], i[2]);
cc.Bacarat2Controller.getInstance().setChipWin(s, i[1], i[2]);
} catch (t) {}
}, this);
cc.director.getScheduler().schedule(function() {
this.runRefundChipForUser();
...
var t = this;
try {
cc.Bacarat2Controller.getInstance().getChipsWin().map(function(e, i) {
i > 5 && (i = 5);
var o = e[2];
if (cc.game.isPaused()) {
...
var t = cc.moveTo(.3, o), i = cc.callFunc(function() {
...
var t = this;
try {
[].concat(this.chipsBetPlayer, this.chipsBetBanker).map(function(e, i) {
i > 5 && (i = 5);
var o = e[2];
if (cc.game.isPaused()) {
cc.Bacarat2Controller.getInstance().putChipToPool(e[0], e[1]);
...
switch (t = parseInt(t)) {
case cc.BacaratBetSite.PLAYER_PAIR:
o = this.chipsBetPPair;
break;

case cc.BacaratBetSite.PLAYER:
o = this.chipsBetPlayer;
break;
...
case cc.BacaratBetSite.BANKER:
o = this.chipsBetBanker;
break;

case cc.BacaratBetSite.BANKER_PAIR:
o = this.chipsBetPBanker;
}
if (0 !== o.length && (!e || t != cc.BacaratBetSite.PLAYER && t != cc.BacaratBetSite.BANKER)) {
o.map(function(t, e) {
try {
e > 5 && (e = 5);
var o = i.posDealer.position;
if (cc.game.isPaused()) {
...
"use strict";
cc._RF.push(e, "d6662fIljNNx42eq6O/MUAS", "BauCuaController");
(function() {
var t;
t = function() {
var t;
...
"use strict";
cc._RF.push(e, "1b549c1mklD5rjTtQDvGtRc", "BauCuaGraphItem");
(function() {
...
"use strict";
cc._RF.push(e, "a45a1Kp8SlIE7LigBCha0Mz", "BauCuaGraphView");
(function() {
...
if (t) {
t.map(function(t, i) {
e.calcSumDice(t.FirstDice);
e.calcSumDice(t.SecondDice);
e.calcSumDice(t.ThirdDice);
var o = e.poolItemDice.get();
0 !== i && (o.opacity = 150);
o.getComponent("BauCuaGraphItem").setResultDice(t);
...
"use strict";
cc._RF.push(e, "5e40cyiwURDX59LcM5g5Q4v", "BauCuaGroupItem");
(function() {
...
"use strict";
cc._RF.push(e, "d54a6zhkQ9DUJVmNz1I3fjC", "BauCuaGroupUserCommand");
(function() {
var t;
t = function() {
function t() {}
...
"use strict";
cc._RF.push(e, "f2871HuC2xAVKvyMQATrTjX", "BauCuaGroupUserListView");
(function() {
...
"use strict";
cc._RF.push(e, "2dc2ef1KGpCp4hskT3To5n0", "BauCuaGroupUserView");
(function() {
...
"use strict";
cc._RF.push(e, "5ab2bpJjgBAbKXrin/qZuB+", "BauCuaHelpView");
(function() {
...
"use strict";
cc._RF.push(e, "a4097KiDdtCS52k4biYhqlj", "BauCuaHistoryItem");
(function() {
...
"use strict";
cc._RF.push(e, "51047zsIR1Oib2gj4mWSS5h", "BauCuaHistoryListView");
(function() {
...
"use strict";
cc._RF.push(e, "5989cxgSGxKepgrbXJkc3/1", "BauCuaHistoryView");
(function() {
...
"use strict";
cc._RF.push(e, "4df81muDbFJlrmwR5i+621F", "BauCuaInfoView");
(function() {
...
var e = this, i = parseInt(t.Phrase);
switch (i) {
...
this.currentState !== i && this.controller.enableClickBet(!1);
break;
...
this.timeInt = i;
if (i > 0) {
this.lbTimer.string = i;
i <= 3 && this.currentState === cc.XXState.BETTING && (this.lbTimer.node.color = cc.Color.RED);
}
}
...
this.timer = 1e3 * t;
var o = this.nodeBarTimer.getComponent(cc.Sprite);
try {
o && (o.fillRange = e.timer / 1e3 / 100 * 5);
this.timerInterval = setInterval(function() {
e.timer -= 100;
if (null != o && null != o.fillRange) try {
o.fillRange = e.timer / 1e3 / 100 * 5;
} catch (t) {
...
this.currentState, cc.BauCuaPharse.EndBetting;
[ cc.BauCuaPharse.Waiting, cc.BauCuaPharse.None, cc.BauCuaPharse.Shaking, cc.BauCuaPharse.ShowResult, cc.BauCuaPharse.OpenPlate ].includes(this.currentState);
}
}
},
...
"use strict";
cc._RF.push(e, "93ad0fuC/JHe7bShAgzUGjK", "BauCuaPharse");
cc.BauCuaPharse = {
None: -1,
Waiting: 0,
Shaking: 1,
...
"use strict";
cc._RF.push(e, "1672bec/JNGGZYTVkbvtKUf", "BauCuaPlayer");
(function() {
...
var e = t.Avatar;
(e <= 0 || e > 15) && (e = Math.floor(15 * Math.random()));
this.avatar.setAvatar(cc.BauCuaController.getInstance().getAvatars()[e - 1]);
...
"use strict";
cc._RF.push(e, "22fe0zEb6JMFaEryRSCBxrX", "BauCuaPopupController");
(function() {
var t;
t = function() {
var t;
...
"use strict";
cc._RF.push(e, "5ee844o955GfpKNzLSL7leE", "BauCuaPopupView");
(function() {
...
var t = cc.instantiate(this.prefabGroupUser);
t.parent = this.node;
t.setPosition(600, 0);
},
...
"use strict";
cc._RF.push(e, "8e814n2qABE34p3PvyBmRc8", "BauCuaResultView");
(function() {
...
"use strict";
cc._RF.push(e, "61387rRf2tAHYsISPqPmBBp", "BauCuaSettingView");
(function() {
...
this.openPopup = !1;
this.node.runAction(cc.moveTo(.2, cc.v2(-400, 0)));
}
},
closeSettingClicked: function() {
this.node.runAction(cc.moveTo(.5, cc.v2(-400, 0)));
},
...
BauCuaSoiCauView: [ function(t, e) {
"use strict";
cc._RF.push(e, "44879CdW89L7q/feROE9iVU", "BauCuaSoiCauView");
(function() {
cc.BauCuaSoiCauView = cc.Class({
extends: cc.Component,
properties: {},
onLoad: function() {
this.openPopup = !1;
...
"use strict";
cc._RF.push(e, "372e0OX8yBPKbavSG+QnjAc", "BauCuaTopItem");
(function() {
...
"use strict";
cc._RF.push(e, "68f1d4tPtBI6om+ETEzr8L0", "BauCuaTopListView");
(function() {
...
"use strict";
cc._RF.push(e, "40559qYzzRHkIQT4dNsYCHy", "BauCuaTopView");
(function() {
...
"use strict";
cc._RF.push(e, "16767uiwL1DcJunoUEidkOg", "BauCuaView");
var i = t("NetConfig");
(function() {
...
cc.BalanceController.getInstance().updateBalance(t.A[1]);
...
cc.BalanceController.getInstance().updateBalance(t.A[0].Balance);
...
"use strict";
cc._RF.push(e, "74c6c+o4VJOKq8g4VAJzBjD", "BauCua_HistoryCommand");
(function() {
var t;
t = function() {
function t() {}
...
"use strict";
cc._RF.push(e, "c358fTEIyJDBKkLVqvS3yxy", "BauCua_SoiCauCommand");
(function() {
var t;
t = function() {
function t() {}
...
"use strict";
cc._RF.push(e, "ba997PMXqVAv5SwCknQhEI+", "BauCua_WinnerCommand");
(function() {
var t;
t = function() {
function t() {}
...
"use strict";
cc._RF.push(e, "69e6coaze9DEKTi3ibUJaIy", "DragonTigerButtonBet");
(function() {
...
"use strict";
cc._RF.push(e, "9acb2UP6JtN65VYNVGFdY6I", "ItemDice");
(function() {
...
JackpotBauCua: [ function(t, e, i) {
"use strict";
cc._RF.push(e, "4c3dcuBFQFAPZmcHdLh4DpN", "JackpotBauCua");
...
if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(t, e, i, o); else for (var c = t.length - 1; c >= 0; c--) (n = t[c]) && (a = (s < 3 ? n(a) : s > 3 ? n(e, i, a) : n(e, i)) || a);
return s > 3 && a && Object.defineProperty(e, i, a), a;
};
Object.defineProperty(i, "__esModule", {
value: !0
});
var a = cc._decorator, c = a.ccclass, r = (a.property, function(t) {
n(e, t);
function e() {
...
}, {}, [ "BauCuaChipsView", "DragonTigerButtonBet", "JackpotBauCua", "AudioPoolBauCua", "BauCuaGroupUserCommand", "BauCua_HistoryCommand", "BauCua_SoiCauCommand", "BauCua_WinnerCommand", "BauCuaAnim", "BauCuaBetSide", "BauCuaPharse", "BauCuaController", "BauCuaPopupController", "BauCuaGraphItem", "BauCuaGraphView", "ItemDice", "BauCuaGroupItem", "BauCuaGroupUserListView", "BauCuaGroupUserView", "BauCuaHelpView", "BauCuaHistoryItem", "BauCuaHistoryListView", "BauCuaHistoryView", "BauCuaPlayer", "BauCuaTopItem", "BauCuaTopListView", "BauCuaTopView", "BauCuaAssetsView", "BauCuaBetView", "BauCuaButtonBet", "BauCuaChipView", "BauCuaInfoView", "BauCuaPopupView", "BauCuaResultView", "BauCuaSettingView", "BauCuaSoiCauView", "BauCuaView" ]);