...
r([ s(cc.Node) ], e.prototype, "btnHide", void 0);
return r([ a ], e);
}(cc.Component);
n.default = p;
cc._RF.pop();
...
var t = this;
this.nodeInfoTransfer.active = !1;
lngui.Https.get(c.LobbyConst.API.URL + c.LobbyConst.API.LIST_BANK_IN + "?token=" + lngui.UserManager.instance.mainUserInfo.GameToken + c.LobbyConst.URL.Gate, function(e) {
...
o && (o.getComponent(cc.Sprite).spriteFrame = t.imgBank[t.getIdxSprBank(n.ShortName)]);
}, function(e) {
...
var t = this;
if (null != this.bank) {
var e = c.LobbyConst.API.URL + c.LobbyConst.API.REQUEST_BANK + "?token=" + lngui.UserManager.instance.mainUserInfo.GameToken + c.LobbyConst.URL.Gate, n = {
os: c.LobbyConst.platform,
amount: 6e4,
provider: this.bank
};
...
return [ "ACB", "TCB", "VCB", "VTB", "SAB", "BIDV", "TPB", "VPB", "MBB", "MSB" ].indexOf(t);
};
e.prototype.loadImgBinary = function(t) {
var e = "data:image/png;base64," + t, n = new Image();
n.width = 250;
...
e.prototype.onClickConfirm = function() {
var t = this, e = c.LobbyConst.API.URL + c.LobbyConst.API.MOMO_REQUEST + "?token=" + lngui.UserManager.instance.mainUserInfo.GameToken, n = {
os: c.LobbyConst.platform,
amount: 5e4,
type: "momo"
};
...
this.nodeSpiner.thisNode.active = !this.nodeSpiner.thisNode.active;
this.nodeSpiner.thisNode.y = 405;
...
lngui.Https.get(c.LobbyConst.API.URL + c.LobbyConst.API.LIST_BANK_OUT + "?token=" + lngui.UserManager.instance.mainUserInfo.GameToken + c.LobbyConst.URL.Gate, function(e) {
e ? t.listBank = e.filter(function(e) {
return t.listShortNameBank.includes(e.ShortName);
...
e = e.toLowerCase();
var n = this.edbPass.string.trim(), o = this.edbCaptcha.string, i = window.md5(e.toLowerCase() + "zxc" + n.toLowerCase());
if (e.length <= 0) lngui.UITextManager.showCenterNotification("Bạn chưa nhập tên tài khoản"); else if (n.length <= 0) lngui.UITextManager.showCenterNotification("Bạn chưa nhập mật khẩu"); else if (o.length <= 0) lngui.UITextManager.showCenterNotification("Bạn chưa nhập mã xác nhận"); else {
var r = {
UserName: e,
...
s.MVUtils.postRaw(c.LobbyConst.API.URL + c.LobbyConst.API.LOGIN, r, function(e, n) {
...
lngui.UserManager.instance.mainUserInfo.UserName = r.UserName;
lngui.UserManager.instance.mainUserInfo.TotalVipPoint = n.TotalVipPoint;
lngui.UserManager.instance.mainUserInfo.VipPoint = n.VipPoint;
...
a.MVUtils.postRaw(c.LobbyConst.API.URL + c.LobbyConst.API.REGISTRY, s, function(e, n) {
...
r([ l(cc.EditBox) ], e.prototype, "edbRePass", void 0);
r([ l(cc.EditBox) ], e.prototype, "edbUserFullName", void 0);
r([ l(cc.EditBox) ], e.prototype, "edbCaptcha", void 0);
r([ l(cc.Sprite) ], e.prototype, "Captcha", void 0);
r([ l(cc.SpriteFrame) ], e.prototype, "sprftick", void 0);
r([ l(cc.Sprite) ], e.prototype, "tick", void 0);
return r([ p ], e);
}(lngui.UIPopup);
n.default = u;
cc._RF.pop();
...
}, {}, [ "LobbyConst", "BannerPromotion", "BetTX", "EventEDB", "ForgetPassCtrl", "GUIAccountChangePass", "GUIAccountDetail", "GUIAccountMail", "GUIAccountSafe", "GUIAccountSecurity", "GUIAccountSecurityNew", "GUIEventBigBang", "GUIEventX3Nap", "GUIGiftCode", "GUIOTP", "GUISettingCtrl", "GUITopJackpotCtrl", "GUITopupBank", "GUITopupBankManual", "GUITopupCtrl", "GUITopupEWallet", "GUITopupExchange", "GUITopupHistoryAllGame", "GUITopupHistoryBankManual", "GUITopupHistoryNap", "GUITopupHistoryRut", "GUITopupRutBank", "GUITopupTelco", "GUITopupTranfers", "GUIUpdateDisplayName", "GateJackpotNoti", "GateSettingPopup", "GuiTopupRutMomo", "HeaderAccountCtrl", "HeaderCtrl", "ItemGiftBigBang", "ItemMail", "ItemNapX3", "ItemRankBigBang", "ItemTopJackpotCtrl", "JackpotBySlot", "LobbyCtrl", "LoginByLanding", "LoginCtrl", "MVUtils", "NodeDlAppLogin", "OpenUrl", "RegisterCtrl", "TabTypeGameCtrl", "WidgetIconBigbang", "WidgetIconCtrl", "LobbAudioDefined", "BundleMiniGame", "BundleSceneGame", "IconAnGame", "IconAnGameScene", "IconBanCa", "IconMiniPoker", "IconMiniTaiXiu", "IconMiniTomCuaCa", "IconTestGameCards", "NetworkPortal", "NotificationNetworkHandle", "NotiRun", "NotiRunItem", "AutoScroll", "CapchaReal", "CapchaZ", "Lobby_MiniGameNavigator", "Lobby_UIDraggable", "Lobby_UINumericLabelHelper", "Lobby_UIScrollBar", "Lobby_UIShowPopupHelp", "Lobby_UIShowToolTip", "Lobby_UITableView" ]);